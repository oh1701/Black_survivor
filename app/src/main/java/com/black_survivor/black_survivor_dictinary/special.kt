    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): special.ViewHolder {
        ...
        fun specialarray(i:Int){
            ...
            if (special_Item[i].name1 == "올가미") {
                item.te("올가미", "트랩 발동: 트랩 피해 +10", "항구(3), 연못(5), 모래사장(3), 양궁장(3), 숲(5), 성당(3)의 상자\n" +
                        "맷돼지(가끔)를 처치", "일반")
                item.up("대나무 트랩", "부비트랩", "", "", "")
                item.down("", "", "", "", "")
            }
            ...
            if (special_Item[i].name1 == "가시 발판") {
                item.te("가시 발판", "트랩 발동: 대상의 이동속도가 1.5초간 20% 감소합니다.\n" +
                        "트랩 피해 +105", "[제작] 쥐덫 + 못\n초록색 항공 보급", "고급")
                item.up("폭뢰침", "히든 메이든", "리모트 마인", "다마스커스 가시", "")
                item.down("쥐덫", "못", "", "", "")
            }
            ...
            if (special_Item[i].name1 == "개량형 쥐덫") {
                item.te("개량형 쥐덫", "트랩 피해 +125", "[제작] 쥐덫 + 철광석\n초록색 항공 보급", "고급")
                item.up("", "", "", "", "")
                item.down("철광석", "쥐덫", "", "", "")
            }
            ...
            if (special_Item[i].name1 == "소란 발생기") {
                item.te("소란 발생기", "트랩 피해 +60", "[제작] 캔 + 쇠구슬\n초록색 항공 보급", "고급")
                item.up("락커의 자켓", "", "", "", "")
                item.down("캔", "쇠구슬", "", "", "")
            }
            ...
            if (special_Item[i].name1 == "히든 메이든") {
                item.te("히든 메이든", "트랩 발동: 대상의 이동속도가 2초간 40% 감소합니다.\n" +
            ...
            if (special_Item[i].name1 == "C-4") {
                item.te("C-4", "트랩 발동: 1.2초 후 넓은 범위로 폭발합니다\n" +
            ...
            if (special_Item[i].name1 == "정찰 드론") {
                item.te("정찰 드론", "지속 시간동안 효과 범위의 공중 시야를 밝혀줍니다. 투명 및 은신은 감지하지 못합니다.", "[제작] 감시 카메라 + 방전 전지", "고급")
                item.up("EMP 드론", "", "", "", "")
                item.down("감시 카메라", "방전 전지", "", "", "")
            }
            if (special_Item[i].name1 == "EMP 드론") {
                item.te("EMP 드론", "EMP 필드 생성 후 지속 시간동안 범위 내 모든 트랩/포탑을 무력화 및 공중 시야를 밝혀줍니다.",
                    "[제작] 정찰 드론 + 화약", "희귀")
                item.down("정찰 드론", "화약", "", "", "")
            }
        }
