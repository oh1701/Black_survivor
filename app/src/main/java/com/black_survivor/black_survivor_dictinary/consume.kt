        ...
        fun falsearray(i: Int) {
            ...
            if (falselist[i].name1 == "식칼") {
                te(
                    "식칼",
                    "공격력 +4" + "이동속도 +0.05",
                    "단검 사용 시 기본 지급, 골목길(5개), 호텔(4개), 절(3개)의 상자\n, 멧돼지(사냥)",
                    "일반"
                )
            ...
            if (falselist[i].name1 == "카른웬난") {
                te(
                    "카른웬난",
                    "공격력 +30, 이동속도 +0.1, 체력 재생 +1.5\n 쿨다운 감소 +10%, 기본 공격 추가 피해 +29",
                    "[제작] \n 장미칼 + 성자의 유산",
                    "영웅"
                )
                up("장미칼", "성자의 유산", "", "", "")
            ...
            if (falselist[i].name1 == "레바테인") {
                te(
                    "레바테인",
                    "공격력 +75, 체력 재생 +1.5, 스태미너 재생 +1.5, 기본공격 추가 피해 +20",
                    "[제작] 삼매진화 + 샴쉬르",
                    "전설"
                )
                down("삼매진화", "샴쉬르", "", "", "")
            ...
            if (falselist[i].name1 == "하르페") {
                te(
                    "하르페",
                    "공격력 +125, 이동속도 +0.1, 스킬 증폭 +38, 스킬 공격 사거리+0.5, 스킬 적중 시 치유 감소 -40%",
                    "[제작] 사신의 낫 + 백우선",
                    "영웅"
                )
                down("사신의 낫", "백우선", "", "", "")
            ...
            if (falselist[i].name1 == "이천일류") {
                te(
                    "이천일류",
                    "공격력 +41, 공격속도 +10%, 생명력 흡수 +18%, 스킬 적중 시 치유 감소 -40%",
                    "[제작] \n피렌체식 쌍검 + 못",
                    "영웅"
                )
                down("피렌체식 쌍검", "못", "", "", "")
            ...
            if (falselist[i].name1 == "발터 PPK\u002dMagnum") {
                te(
                    "발터 PPK",
                    "장탄 수: 6발, 공격력 +8, 이동속도 +0.1",
                    "사용 시 기본 지급\n" + "모래사장(4개), 호텔(5개), 공장(4개)의 상자",
                    "일반"
                )
                up("매그넘-파이썬", "베레타 M92F", "", "", "")
            }
            ...
            if (falselist[i].name1 == "FN57") {
                te(
                    "FN57",
                    "장탄 수: 6발, 공격력 +29, 이동속도 +0.1. 시야 +2.5",
                    "[제작]\n 베레타 M92F + 레이저 포인터",
                    "희귀"
                )
                up("엘레강스", "", "", "", "")
            ...
            if (falselist[i].name1 == "더블 리볼버 SP") {
                te(
                    "더블 리볼버 SP",
                    "장탄 수: 6발, 공격력 +49, 이동속도 +0.1. 공격 속도 +10%",
                    "[제작]\n 베레타 M92F + 매그넘\u002d파이썬",
                    "희귀"
                )
                up("마탄의 사수", "", "", "", "")
            ...
            if (falselist[i].name1 == "STG\u002d44") {
                te(
                    "STG\u002d44",
                    "장탄 수: 30발, 공격력 +18, 시야 +1.5, 기본 공격 추가 피해 +2",
                    "[제작]\n페도로프 자동소총 + 화약",
                    "고급"
                )
                up("AK-47", "M16A1", "기관총", "", "")
            ...
            if (falselist[i].name1 == "AK\u002d47") {
                te(
                    "AK\u002d47",
                    "장탄 수: 30발, 공격력 +29, 시야 +1.5, 기본 공격 추가 피해 +2",
                    "[제작]\nSTG\u002d44 + 피아노선",
                    "희귀"
                )
                up("AK-12", "", "", "", "")
            ...
            if (falselist[i].name1 == "M16A1") {
                te(
                    "M16A1",
                    "장탄 수: 30발, 공격력 +25, 시야 +1.5, 기본 공격 추가 피해 +4",
                    "[제작]\nSTG\u002d44 + 가죽",
                    "희귀"
                )
                up("XCR", "", "", "", "")
            ...
            if (falselist[i].name1 == "기관총") {
                te(
                    "기관총",
                    "장탄 수: 30발, 공격력 +20, 시야 +1.5\n 기본 공격 추가 피해 +11, 공격 속도 +10%",
                    "[제작]\nSTG\u002d44 + 모터",
                    "영웅"
                )
                down("STG-44", "모터", "", "", "")
            ...
            if (falselist[i].name1 == "개틀링건") {
                te(
                    "개틀링건",
                    "장탄 수: 30발, 공격력 +50, 시야 +1.5\n 기본 공격 추가 피해 +12, 공격 속도 +15%",
                    "[제작]기관총 + 오일",
                    "영웅"
                )
                down("기관총", "오일", "", "", "")
            ...
            if (falselist[i].name1 == "스프링필드") {
                te(
                    "스프링필드",
                    "장탄 수 : 1발, 공격력 +50, 이동속도 -0.1, 시야 +1.5",
                    "[제작] 화승총 + 레이저 포인터\n초록색 항공 보급",
                    "고급"
                )
                up("하푼건", "금교전", "레일건", "", "")
            ...
            if (falselist[i].name1 == "금교전") {
                te(
                    "금교전",
                    "장탄 수 : 1발, 공격력 +56, 이동속도 -0.15, 시야 +2.5, 스킬증폭 +18%",
                    "[제작]\n 스프링필드 + 황금",
                    "희귀"
                )
                up("NTW-20", "사사성광", "", "", "")
            ...
            if (falselist[i].name1 == "레일건") {
                te(
                    "레일건",
                    "장탄 수 : 3발, 공격력 +78, 이동속도 -0.15, 시야 +2, 공격속도 +20%",
                    "[제작]\n 스프링필드 + 전자 부품",
                    "희귀"
                )
                up("폴라리스", "", "", "", "")
            ...
            if (falselist[i].name1 == "Tac\u002d50") {
                te(
                    "Tac\u002d50",
                    "장탄 수 : 2발, 공격력 +140, 이동속도 -0.03, 시야 +2.5, 생명력 흡수 +20%",
                    "[제작]\n 하푼건 + 정교한 도면",
                    "영웅"
                )
                down("하푼건", "정교한 도면", "", "", "")
            ...
            if (falselist[i].name1 == "인터벤션") {
                te(
                    "인터벤션",
                    "장탄 수 : 2발, 공격력 +110, 시야 +4.5, 기본 공격 사거리 +1",
                    "[제작]\n 하푼건 + 망원 카메라",
                    "영웅"
                )
                down("하푼건", "망원 카메라", "", "", "")
            ...
            if (falselist[i].name1 == "NTW\u002d20") {
                te(
                    "NTW\u002d20",
                    "장탄 수 : 1발, 공격력 +95, 시야 +2.5, 이동속도 -0.1, 스킬증폭 +22%",
                    "[제작]\n 금교전 + 철판",
                    "영웅"
                )
                down("금교전", "철판", "", "", "")
            ...
            if (falselist[i].name1 == "사사성광") {
                te(
                    "사사성광",
                    "장탄 수 : 1발, 공격력 +95, 시야 +2.5, 이동속도 -0.1, 스킬증폭 +30%",
                    "[제작]\n 문스톤 + 금교전",
                    "전설"
                )
                down("문스톤", "금교전", "", "", "")
            ...
            if (falselist[i].name1 == "바늘") {
                te(
                    "바늘", "공격력 +3, 치명타 피해량 +25%", "사용 시 기본 지급\n" +
            ...
            if (falselist[i].name1 == "매화검") {
                te(
                    "매화검",
                    "공격력 +121, 치명타 확률 +10%, 치명타 피해량 +25%, 쿨다운 감소 +10%",
                    "[제작] \n레이피어 + 운명의 꽃",
                    "희귀"
                )
                up("듀랜달 Mk2", "볼틱레토", "유성검", "", "")
            ...
            if (falselist[i].name1 == "활빈검") {
                te(
                    "활빈검",
                    "공격력 +30, 체력 재생+1.5, 스태미너 재생 +200%, 쿨다운 감소 +12% 치명타 피해량 +25%",
                    "[제작] \n레이피어 + 어사의",
                    "영웅"
                )
                up("미스틸테인", "", "", "", "")
            ...
            if (falselist[i].name1 == "듀랜달 Mk2") {
                te(
                    "듀랜달 Mk2",
                    "공격력 +51, 시야 +3, 치명타 확률 +10%, 치명타 피해량 +25%, 쿨다운 감소 +10%",
                    "[제작]\n 매화검 + 레이저 포인터",
                    "영웅"
                )
                down("매화검", "레이저 포인터", "", "", "")
            ...
            if (falselist[i].name1 == "볼틱레토") {
                te(
                    "볼틱레토",
                    "공격력 +47, 공격속도 +35%, 치명타 확률 +10%, 치명타 피해량 +25%, 쿨다운 감소 +10%",
                    "[제작]\n 매화검 + 전자 부품",
                    "영웅"
                )
                down("매화검", "전자 부품", "", "", "")
            ...
            if (falselist[i].name1 == "미스틸테인") {
                te(
                    "미스틸테인",
                    "공격력 +30, 치명타 피해량 +25%, 쿨다운 감소 +12%, 스태미너 재생 +200%, 체력 재생 +1.5, 스킬 증폭 +17%",
                    "[제작]\n 활빈검 + 나뭇가지",
                    "전설"
                )
                down("활빈검", "나뭇가지", "", "", "")
            ...
            if (falselist[i].name1 == "방천화극") {
                te(
                    "방천화극",
                    "공격력 +88, 이동속도 -0.1, 스킬 적중 시 치유 감소 -40%, 스킬 증폭 +37%",
                    "[제작]\n 도끼창 + 군선",
                    "영웅"
                )
                down("도끼창", "군선", "", "", "")
            ...
            if (falselist[i].name1 == "화첨창") {
                te(
                    "화첨창",
                    "공격력 +110, 체력 재생 +1.5, 스태미너 재생 +1.5, 기본 공격 추가 피해 +30",
                    "[제작]\n 삼매진화 + 죽창",
                    "전설"
                )
                down("삼매진화", "죽창", "", "", "")
            ...
            if (falselist[i].name1 == "쇠구슬") {
                te(
                    "쇠구슬", "장탄 수: 50, 공격력 +12", "양궁장(5개), 숲(7개), 공장(7개)의 상자\n" +
                            "맷돼지(사냥)", "일반"
                )
            ...
            if (falselist[i].name1 == "안티오크의 수류탄") {
                te(
                    "안티오크의 수류탄",
                    "최대 충전 수 : 8발, 공격력 +85, 기본 공격 추가 피해 +80",
                    "[제작]\n고폭 수류탄 + 십자가",
                    "영웅"
                )
                down("고폭 수류탄", "십자가", "", "", "")
            ...
            if (falselist[i].name1 == "다비드슬링") {
                te(
                    "다비드슬링",
                    "최대 충전 수 : 50발, 공격력 +80, 체력재생 +150%, 기본 공격 추가 피해 +30",
                    "[제작]\n슬링 + 성자의 유산",
                    "영웅"
                )
                down("슬링", "성자의 유산", "", "", "")
            ...
            if (falselist[i].name1 == "루테늄 구슬") {
                te(
                    "루테늄 구슬",
                    "최대 충전 수 : 50발, 공격력 +80, 스킬 증폭 +20%, 스킬 적중 시 치유 감소 -40%",
                    "[제작]\n가시 탱탱볼 + 황금",
                    "영웅"
                )
                down("가시 탱탱볼", "황금", "", "", "")
            ...
            if (falselist[i].name1 == "브레이질 건틀릿") {
                te(
                    "브레이질 건틀릿",
                    "공격력 +48, 방어력 +13, 체력 재생 +1, 공격 속도 +30%, 이동속도 -.0.05",
                    "[제작]\n귀골 장갑 + 기름먹인 천 ",
                    "영웅"
                )
                up("", "", "", "", "")
            ...
            if (falselist[i].name1 == "대나무") {
                te(
                    "대나무",
                    "공격력 +12",
                    "사용 시 기본 지급\n" + "연못(7개), 절(7개), 양궁장(6개),묘지(7),숲(7)의 상자, 박쥐(사냥)",
                    "일반"
                )
            ...
            if (falselist[i].name1 == "횃불") {
                te(
                    "횃불",
                    "공격력 +40, 체력 재생 +0.5, 공격 속도 +10%, 이동 속도 +0.1",
                    "[제작]\n먼지털이개 + 기름먹인 천",
                    "희귀"
                )
                up("구원의 여신상", "", "", "", "")
            ...
            if (falselist[i].name1 == "구원의 여신상") {
                te(
                    "구원의 여신상",
                    "공격력 +90, 체력 재생 +0.6, 스태미너 재생 +60%, 공격 속도 +15%, 이동 속도 +0.1, 생명력 흡수 +10%",
                    "[제작]\n횃불 + 인형",
                    "영웅"
                )
                up("", "", "", "", "")
            ...
            if (falselist[i].name1 == "엘리멘탈 보우") {
                te(
                    "엘리멘탈 보우",
                    "공격력 +60, 이동속도 +0.1, 스킬 증폭 +41, 스킬 적중 시 치유 감소 -40%",
                    "[제작]\n화전 + 백우선",
                    "영웅"
                )
                up("", "", "", "", "")
            ...
            if (falselist[i].name1 == "분필") {
                te(
                    "분필", "장탄 수: 50, 공격력 +12", "공장(개), 성당(개), 학교(개)의 상자\n" +
                            "박쥐(사냥)", "일반"
                )
                up("백색 가루", "", "", "", "")
                down("", "", "", "", "")
            ...
            if (falselist[i].name1 == "매화비표") {
                te(
                    "매화비표",
                    "장탄 수: 50, 공격력 +14, 쿨다운 감소 +10%, 기본 공격 추가 피해 +30",
                    "[제작]\n유엽비도 + 꽃",
                    "희귀"
                )
                up("풍마수리검", "", "", "", "")
            ...
            if (falselist[i].name1 == "미치광이왕의 카드") {
                te(
                    "미치광이왕의 카드",
                    "장탄 수: 52, 공격력 +49, 공격속도 +30%, 치명타 확률 +20%",
                    "[제작]\n빈티지 카드 + 이온 전지",
                    "영웅"
                )
                up("", "", "", "", "")
            ...
            if (falselist[i].name1 == "풍마 수리검") {
                te(
                    "풍마 수리검",
                    "장탄 수: 50, 공격력 +44, 쿨다운 감소 +15%, 기본 공격 추가 피해 +36",
                    "[제작]\n매화비표 + 알코올",
                    "영웅"
                )
                up("", "", "", "", "")
            ...
            if (falselist[i].name1 == "루비 스페셜") {
                te(
                    "루비 스페셜",
                    "공격력 +20, 최대 체력 +300, 공격속도 +20%, 기본 공격 추가 피해 +2",
                    "[제작]\n싱글 픽업 + 루비",
                    "희귀"
                )
                up("보헤미안", "", "", "", "")
            ...
            if (falselist[i].name1 == "노캐스터") {
                te(
                    "노캐스터",
                    "공격력 +15, 공격속도 +20%, 생명력 흡수 +10%, 기본 공격 추가 피해 +10",
                    "[제작]\n싱글 픽업 + 정교한 도면",
                    "희귀"
                )
                up("새티스팩션", "", "", "", "")
            ...
            if (falselist[i].name1 == "보헤미안") {
                te(
                    "보헤미안",
                    "공격력 +50, 최대 체력 +380, 공격 속도 +20%\n치명타 확률 +20%, 기본 공격 추가 피해 +2",
                    "[제작]\n루비 스페셜 + 트럼프 카드",
                    "영웅"
                )
                up("", "", "", "", "")
            ...
            if (falselist[i].name1 == "천국의 계단") {
                te(
                    "천국의 계단",
                    "공격력 +52, 체력 재생 +200%, 시야 +4, 스킬 증폭 +20%",
                    "[제작] 험버커 픽업 + 성배\n보라색 항공 보급 ",
                    "영웅"
                )
                up("", "", "", "", "")
            ...
            if (falselist[i].name1 == "새티스팩션") {
                te(
                    "새티스팩션",
                    "공격력 +30, 공격속도 +30%, 생명력 흡수 +10%, 기본 공격 추가 피해 +11",
                    "[제작]\n노캐스터 + 돌멩이",
                    "영웅"
                )
                up("", "", "", "", "")
            ...
            if (falselist[i].name1 == "머리띠") {
                te(
                    "머리띠", "방어력 +4, 최대 스태미너 +130", "번화가(8개), 절(7개), 묘지(7개)의 상자\n" +
                            "박쥐(사냥)", "일반"
                )
                up("가면", "머리테", "", "", "")
                down("", "", "", "", "")
            ...
            if (falselist[i].name1 == "모자") {
                te(
                    "모자", "방어력 +4, 쿨다운 감소 +5%", "연못(7개), 양궁장(5개), 학교(6개)의 상자\n" +
                            "박쥐(가끔)를 처치", "일반"
                )
                up("베레모", "사슬 코이프", "", "", "")
                down("", "", "", "", "")
            ...
            if (falselist[i].name1 == "자전거 헬멧") {
                te(
                    "자전거 헬멧", "최대 체력 +90", "모래사장(6개), 성당(6개), 학교(6개)의 상자\n" +
                            "맷돼지(가끔)를 처치", "일반"
                )
                up("안전모", "방탄모", "", "", "")
                down("", "", "", "", "")
            ...
            if (falselist[i].name1 == "투구") {
                te(
                    "투구",
                    "방어력 +20, 최대 스태미너 +130, 이동속도 +0.1, 쿨다운 감소 +10%",
                    "[제작]사슬 코이프 + 가면\n파란색 항공 보급",
                    "희귀"
                )
                up("기사단장의 투구", "황실 부르고넷", "", "", "")
            ...
            if (falselist[i].name1 == "미스릴 투구") {
                te(
                    "미스릴 투구",
                    "방어력 +38, 공격속도 +12%, 이동속도 +0.2, 쿨다운 감소 +15%",
                    "[제작] 미스릴 + 사슬 코이프\n보라색 항공 보급",
                    "영웅"
                )
                up("", "", "", "", "")
            ...
            if (falselist[i].name1 == "전술-OPS 헬멧") {
                te(
                    "전술-OPS 헬멧",
                    "방어력 +15, 최대 체력 +120, 공격속도 +20%, 쿨다운 감소 +15%",
                    "[제작] 방탄모 + 전자 부품\n보라색 항공 보급",
                    "영웅"
                )
                up("", "", "", "", "")
            ...
            if (falselist[i].name1 == "기사단장의 투구") {
                te(
                    "기사단장의 투구",
                    "방어력 +20, 최대 스태미너 +200, 이동속도 +0.1, 쿨다운 감소 +10%, 스킬 피해 감소 +11%",
                    "[제작] 투구 + 고무\n보라색 항공 보급",
                    "영웅"
                )
                up("", "", "", "", "")
            ...
            if (falselist[i].name1 == "제국 왕관") {
                te(
                    "제국 왕관",
                    "방어력 +18, 최대 체력 +300, 최대 스태미너 +500, 스킬 증폭 +10%",
                    "[제작] 왕관 + 루비\n보라색 항공 보급",
                    "영웅"
                )
                up("", "", "", "", "")
            ...
            if (falselist[i].name1 == "황실 부르고넷") {
                te(
                    "황실 부르고넷",
                    "방어력 +10, 최대 스태미너 +200, 이동속도 +0.1, 쿨다운 감소 +10%, 스킬 증폭 +14%",
                    "[제작] 투구 + 황금\n보라색 항공 보급",
                    "영웅"
                )
                up("", "", "", "", "")
            ...
            if (falselist[i].name1 == "변검") {
                te(
                    "변검",
                    "방어력 +16, 최대 스태미너 +300, 이동속도 +0.1, 생명력 흡수 +22%, 비전투중 이동속도 +0.4",
                    "[제작] 가면 + VF 혈액 샘플\n보라색 항공 보급",
                    "영웅"
                )
                up("", "", "", "", "")
            ...
            if (falselist[i].name1 == "월계관") {
                te(
                    "월계관",
                    "방어력 +18, 최대 스태미너 +580, 체력 재생 +1.5, 스태미너 재생 +2, 기본 공격 추가 피해 +15",
                    "[제작]삼매진화 + 머리테\n노란색 항공 보급",
                    "전설"
                )
                up("", "", "", "", "")
            ...
            if (falselist[i].name1 == "광학미채 슈트") {
                te(
                    "광학미채 슈트",
                    "공격력 +10, 방어력 +20, 치명타 확률 +22%, 스킬 피해 감소 +10%",
                    "[제작] 잠수복 + 유리판\n보라색 항공 보급",
                    "영웅"
                )
                up("", "", "", "", "")
            ...
            if (falselist[i].name1 == "락커의 자켓") {
                te(
                    "락커의 자켓",
                    "공격력 +30, 방어력 +11, 비전투중 이동속도 +0.2, 기본 공격 피해 감소 +15, 스킬 적중 시 치유 감소 -40%",
                    "[제작] 라이더 자켓 + 소란 발생기\n보라색 항공 보급",
                    "영웅"
                )
                up("", "", "", "", "")
            ...
            if (falselist[i].name1 == "성기사의 갑옷") {
                te(
                    "성기사의 갑옷",
                    "방어력 +30, 체력 재생 +200%, 이동속도 -0.02, 기본 공격 추가 피해 +15",
                    "[제작] 판금 갑옷 + 성자의 유산\n보라색 항공 보급",
                    "영웅"
                )
                up("", "", "", "", "")
            ...
            if (falselist[i].name1 == "용의 도복") {
                te(
                    "용의 도복",
                    "공격력 +11, 방어력 +10, 스태미너 재생 +150%, 쿨다운 감소 +10%, 기본 공격 사거리 +1",
                    "[제작] 치파오 + 거북 도복\n보라색 항공 보급",
                    "영웅"
                )
                up("", "", "", "", "")
            ...
            if (falselist[i].name1 == "집사복") {
                te(
                    "집사복",
                    "공격력 +30, 이동속도 +0.1, 생명력 흡수 +20%, 기본 공격 피해 감소 +10",
                    "[제작] 정장 + 먼지털이개\n보라색 항공 보급",
                    "영웅"
                )
                up("", "", "", "", "")
            ...
            if (falselist[i].name1 == "배틀 슈트") {
                te(
                    "배틀 슈트",
                    "방어력 +25, 최대 체력 +140, 기본 공격 피해 감소 +12, 스킬 피해 감소 +12%",
                    "[제작] 방탄조끼 + 잠수복\n보라색 항공 보급",
                    "영웅"
                )
                up("", "", "", "", "")
            ...
            if (falselist[i].name1 == "EOD 슈트") {
                te(
                    "EOD 슈트",
                    "방어력 +15, 최대 체력 +300, 체력 재생 +1, 쿨다운 감소 +10%, 기본 공격 피해 감소 +10",
                    "[제작] 방탄조끼 + 덧댄 로브\n보라색 항공 보급",
                    "영웅"
                )
                up("", "", "", "", "")
            ...
            if (falselist[i].name1 == "불꽃 드레스") {
                te(
                    "불꽃 드레스",
                    "방어력 +25, 체력 재생 +2.5, 스태미너 재생 +3, 스태미너 재생 +75%, 기본 공격 추가 피해 +18",
                    "[제작] 삼매진화 + 드레스\n노란색 항공 보급",
                    "전설"
                )
                up("", "", "", "", "")
            ...
            if (falselist[i].name1 == "손목시계") {
                te(
                    "손목시계", "공격속도 +10%", "고급 주택가(6개), 호텔(6개), 번화가(8개)의 상자\n" +
                            "들개(가끔)를 처치", "일반"
                )
                up("바이탈 센서", "큐브 워치", "", "", "")
                down("", "", "", "", "")
            ...
            if (falselist[i].name1 == "붕대") {
                te(
                    "붕대", "체력 재생 +0.8", "항구(7개), 병원(6개), 공장(6개), 학교(6)의 상자\n" +
                            "박쥐(가끔)를 처치", "일반"
                )
            ...
            if (falselist[i].name1 == "팔찌") {
                te(
                    "팔찌", "최대 스태미너 +200", "연못(7개), 고급 주택가(6개), 골목길(6개)의 상자\n" +
                            "들개(가끔)를 처치", "일반"
                )
                up("금팔찌", "진홍 팔찌", "", "", "")
                down("", "", "", "", "")
            ...
            if (falselist[i].name1 == "소드 스토퍼") {
                te(
                    "소드 스토퍼",
                    "방어력 +26, 기본 공격 피해 감소 +11, 기본 공격 시 치유 감소 -40%",
                    "[제작] 바주반드 + 못\n보라색 항공 보급",
                    "영웅"
                )
                up("", "", "", "", "")
            ...
            if (falselist[i].name1 == "드라우프니르") {
                te(
                    "드라우프니르",
                    "방어력 +10, 최대 스태미너 +240, 체력 재생 +1, 스킬 증폭 15%",
                    "[제작] 금팔찌 + 브레이서\n보라색 항공 보급",
                    "영웅"
                )
                up("", "", "", "", "")
            ...
            if (falselist[i].name1 == "미스릴 방패") {
                te(
                    "미스릴 방패",
                    "공격력 +30, 방어력 +30, 공격속도 +12%, 이동속도 +0.1",
                    "[제작] 미스릴 + 가죽 방패\n보라색 항공 보급",
                    "영웅"
                )
                up("", "", "", "", "")
            ...
            if (falselist[i].name1 == "기사의 신조") {
                te(
                    "기사의 신조",
                    "공격력 +30, 방어력 +25, 체력 재생 +1.5, 이동속도 -0.1, 치명타 피해량 +20%",
                    "[제작] 강철 방패 + 분대장 완장\n보라색 항공 보급",
                    "영웅"
                )
                up("", "", "", "", "")
            ...
            if (falselist[i].name1 == "샤자한의 검집") {
                te(
                    "샤자한의 검집",
                    "공격력 +28, 최대 체력 +300, 기본 공격 피해 감소 +2",
                    "[제작] 검집 + 루비\n보라색 항공 보급",
                    "영웅"
                )
                up("", "", "", "", "")
            ...
            if (falselist[i].name1 == "스카디의 팔찌") {
                te(
                    "스카디의 팔찌",
                    "최대 체력 +200, 최대 스태미너 +250, 체력 재생 +2, 스태미너 재생 +2, 스킬 증폭 +20",
                    "[제작] 만년빙 + 진홍 팔찌\n노란색 항공 보급",
                    "전설"
                )
                up("", "", "", "", "")
            ...
            if (falselist[i].name1 == "슬리퍼") {
                te(
                    "슬리퍼", "스태미너 재생 +0.5, 이동속도 +0.04", "번화가(8개), 병원(6개), 학교(7개)의 상자\n" +
                            "박쥐(가끔)를 처치", "일반"
                )
                up("하이힐", "덧댄 슬리퍼", "", "", "")
                down("", "", "", "", "")
            ...
            if (falselist[i].name1 == "운동화") {
                te(
                    "운동화", "이동속도 +0.08", "고급 주택가(6개), 골목길(7개), 양궁장(5개)의 상자\n" +
                            "들개(가끔)를 처치", "일반"
                )
                up("힐리스", "부츠", "", "", "")
                down("", "", "", "", "")
            ...
            if (falselist[i].name1 == "타이즈") {
                te(
                    "타이즈", "방어력 +5, 이동속도 +0.04", "번화가(8개), 병원(6개), 숲(7개)의 상자\n" +
                            "맷돼지(가끔)를 처치\n", "일반"
                )
                up("무릎 보호대", "체인 레깅스", "", "", "")
                down("", "", "", "", "")
            ...
            if (falselist[i].name1 == "덧댄 슬리퍼") {
                te(
                    "덧댄 슬리퍼",
                    "스태미너 재생 +0.5, 스태미너 재생 +30%, 이동속도 +0.16",
                    "[제작] 슬리퍼 + 옷감\n초록색 항공 보급",
                    "고급"
                )
                up("풍화륜", "글레이셜 슈즈", "", "", "")
            ...
            if (falselist[i].name1 == "매버릭 러너") {
                te(
                    "매버릭 러너",
                    "공격속도 +15%, 이동속도 +0.25, 비전투중 이동속도 +0.5",
                    "[제작] 힐리스 + 전자 부품\n파란색 항공 보급",
                    "희귀"
                )
                up("", "", "", "", "")
            ...
            if (falselist[i].name1 == "킬힐") {
                te(
                    "킬힐",
                    "공격력 +5, 스태미너 재생 +0.8, 이동속도 +0.16, 치명타 확률 +10%",
                    "[제작] 하이힐 + 유리 조각\n파란색 항공 보급",
                    "희귀"
                )
                up("분홍신", "부케팔로스", "", "", "")
            ...
            if (falselist[i].name1 == "풍화륜") {
                te(
                    "풍화륜",
                    "스태미너 재생 +1, 스태미너 재생 +50%, 이동속도 +0.35, 스킬증폭 +10",
                    "[제작] 덧댄 슬리퍼 + 재\n파란색 항공 보급",
                    "희귀"
                )
                up("", "", "", "", "")
            ...
            if (falselist[i].name1 == "부케 팔로스") {
                te(
                    "부케 팔로스",
                    "공격력 +5, 방어력 +5, 스태미너 재생 +1, 이동속도 +0.33, 치명타 확률 +17%",
                    "[제작]킬힐 + 체인 레깅스\n보라색 항공 보급",
                    "영웅"
                )
                up("", "", "", "", "")
            ...
            if (falselist[i].name1 == "클링온 부츠") {
                te(
                    "클링온 부츠",
                    "체력 재생 +0.7, 공격속도 +15, 이동속도 +0.35, 기본 공격 시 치유 감소 -40%",
                    "[제작] 전투화 + 못\n보라색 항공 보급",
                    "영웅"
                )
                up("", "", "", "", "")
            ...
            if (falselist[i].name1 == "글레이셜 슈즈") {
                te(
                    "글레이셜 슈즈",
                    "체력 재생 +2, 스태미너 재생 +2, 스태미너 재생 +60%, 이동속도 +0.15, 비전투중 이동속도 +0.5, 스킬증폭 +15",
                    "[제작] 덧댄 슬리퍼 + 만년빙\n노란색 항공 보급",
                    "전설"
                )
                up("", "", "", "", "")
            ...
            if (falselist[i].name1 == "헤르메스의 부츠") {
                te(
                    "헤르메스의 부츠",
                    "방어력 +40, 이동속도 +0.4, 비전투중 이동 속도+0.2",
                    "[제작] 포스 코어 + 힐리스\n노란색 항공 보급",
                    "전설"
                )
                up("", "", "", "", "")
            ...
            if (falselist[i].name1 == "분홍신") {
                te(
                    "분홍신",
                    "공격력 +5, 스태미너 재생 +1, 이동속도 +0.4, 치명타 확률 +10%, 생명력 흡수 +15%",
                    "[제작] 킬힐 + VF 혈액 샘플\n노란색 항공 보급",
                    "전설"
                )
                up("", "", "", "", "")
            ...
            if (falselist[i].name1 == "리본") {
                te(
                    "리본", "생명력 흡수 +5%", "연못(6개),고급 주택가(7), 학교(7개)의 상자\n" +
                            "들개(가끔)를 처치", "일반"
                )
                up("정장", "인형", "달빛 펜던트", "", "")
                down("", "", "", "", "")
            ...
            if (falselist[i].name1 == "부채") {
                te(
                    "부채", "스킬증폭 +11", "번화가(8개), 숲(8개), 성당(6개)의 상자\n" +
                            "들개(가끔)를 처치", "일반"
                )
                up("군선", "우치와", "우산", "바람 채찍", "")
                down("", "", "", "", "")
            ...
            if (falselist[i].name1 == "상자") {
                te(
                    "상자", "최대 체력 +90", "항구(7개), 연못(7), 성당(6)의 상자\n" +
                            "박쥐(가끔)를 처치", "일반"
                )
            ...
            if (falselist[i].name1 == "십자가") {
                te(
                    "십자가", "기본 공격 추가 피해 +7", "골목길(7개), 성당(9개)\n" +
                            "들개(가끔)를 처치", "일반"
                )
            ...
            if (falselist[i].name1 == "쌍안경") {
                te(
                    "쌍안경", "기본 공격 추가 피해 +7", "모래사장(6개), 골목길(7개), 호텔(6), 공장(7)\n" +
                            "박쥐(가끔), 들개(가끔)를 처치", "일반"
                )
            ...
            if (falselist[i].name1 == "백우선") {
                te(
                    "백우선",
                    "이동속도 +0.1, 스킬증폭 +16, 스킬 적중 시 치유 감쇼 -40%",
                    "[제작] 군선 + 깃털\n파란색 항공 보급",
                    "희귀"
                )
                up("하르페", "엘리멘탈 보우", "", "", "")
            ...
            if (falselist[i].name1 == "생명의 가루") {
                te(
                    "생명의 가루",
                    "체력 재생 +1.5, 스태미너 재생 +1.5",
                    "[제작] 생명의 나무 + 돌멩이, 곰(사냥), 위클라인(사냥)\n파란색 항공 보급",
                    "희귀"
                )
                up("만년빙", "삼매진화", "포스 코어", "", "")
                down("생명의 나무", "돌멩이", "", "", "")
            ...
            if (falselist[i].name1 == "진리는 나의 빛") {
                te(
                    "진리는 나의 빛",
                    "체력 재생 +150%, 쿨다운 감소 +10%, 기본 공격 추가 피해 +12, 스킬 증폭 +8%",
                    "[제작] 진신사리 + 성자의 유산\n파란색 항공 보급",
                    "희귀"
                )
                up("", "", "", "", "")
            ...
            if (falselist[i].name1 == "만년빙") {
                te(
                    "만년빙",
                    "체력 재생 +1.5, 스태미너 재생 +1.5, 스킬 증폭 +18",
                    "[제작] 생명의 가루 + 얼음\n보라색 항공 보급",
                    "영웅"
                )
                up("스카디의 팔찌", "글레이셜 슈즈", "", "", "")
            ...
            if (falselist[i].name1 == "삼매진화") {
                te(
                    "삼매진화",
                    "체력 재생 +1.5, 스태미너 재생 +1.5, 기본 공격 추가 피해 +13",
                    "[제작] 생명의 가루 + 라이터\n보라색 항공 보급",
                    "영웅"
                )
            ...
            if (falselist[i].name1 == "에메랄드 타블렛") {
                te(
                    "에메랄드 타블렛",
                    "공격력 +10, 방어력 +10, 치명타 확률 +15%, 쿨다운 감소 +10%",
                    "[제작] 포스 코어 + 운명의 꽃\n노라색 항공 보급",
                    "전설"
                )
                up("", "", "", "", "")
            ...
            if (falselist[i].name1 == "뜨거운 꿀물") {
                te(
                    "뜨거운 꿀물", "스태미너 재생 +1080", "[제작] 뜨거운 물 + 꿀\n" +
                            "파란색 항공 보급", "희귀"
                )
                up("", "", "", "", "")
                down("뜨거운 물", "꿀", "", "", "")
            ...
            if (falselist[i].name1 == "아메리카노") {
                te(
                    "아메리카노", "스태미너 재생 +1080", "[제작] 뜨거운 물 + 커피콩\n" +
                            "파란색 항공 보급", "희귀"
                )
                up("", "", "", "", "")
                down("뜨거운 물", "커피콩", "", "", "")
            ...
            if (falselist[i].name1 == "감시 카메라") {
                te(
                    ...
                    "항구, 모래사장, 고급 주택가, 번화가, 병원, 양궁장, 묘지, 학교의 상자\n 박쥐, 맷돼지, 들개(사냥)",
                    "일반"
                )
                up("망원 카메라", "", "", "", "")
                down("", "", "", "", "")
            ...
            if (falselist[i].name1 == "올가미") {
                te(
                    "올가미",
                    "트랩 발동: 대상을 0.5초 간 속박, 트랩 피해 +10",
                    "항구(6), 연못(6), 모래사장(5), 양궁장(5), 숲(5), 성당(5)의 상자\n" +
                            "맷돼지(가끔)를 처치",
                    "일반"
                )
                up("대나무 트랩", "부비트랩", "", "", "")
            ...
            if (falselist[i].name1 == "쥐덫") {
                te(
                    "쥐덫", "트랩 피해 +50", "연못(7), 모래사장(5), 묘지(6)의 상자\n" +
                            "맷돼지(가끔)를 처치", ""
                )
            ...
            if (falselist[i].name1 == "가시 발판") {
                te(
                    "가시 발판", "트랩 발동: 대상의 이동속도가 1.5초간 20% 감소합니다.\n" +
                            "트랩 피해 +120", "[제작] 쥐덫 + 못\n초록색 항공 보급", "고급"
                )
            ...
            if (falselist[i].name1 == "다이너마이트") {
                te(
                    "다이너마이트", "트랩 발동: 1.5초 후 넓은 범위로 폭발합니다.\n" +
            ...
            if (falselist[i].name1 == "폭발 트랩") {
                te(
                    "폭발 트랩", "트랩 발동: 1.5초 후 넓은 범위로 폭발합니다.\n" +
                            "트랩 피해 +180", "[제작] 쥐덫 + 화약\n초록색 항공 보급", "고급"
                )
                up("화염 트랩", "크레모어", "", "", "")
                down("쥐덫", "화약", "", "", "")
            ...
            if (falselist[i].name1 == "지뢰") {
                te(
                    "지뢰", "트랩 발동: 좁은 범위로 폭발하며, 피격된 대상은 1초간 기절합니다.\n" +
                            "트랩 피해 +80", "[제작] 부비트랩 + 화약\n 파란색 항공 보급", "희귀"
                )
                up("크레모어", "", "", "", "")
                down("부비트랩", "화약", "", "", "")
            ...
            if (falselist[i].name1 == "화염 트랩") {
                te(
                    "화염 트랩", "트랩 발동: 1.5초 후 넓은 범위로 폭발합니다.\n" +
            ...
            if (falselist[i].name1 == "히든 메이든") {
                te(
                    "히든 메이든", "트랩 발동: 대상의 이동속도가 2초간 30% 감소합니다.\n" +
            ...
            if (falselist[i].name1 == "폭뢰침") {
                te(
                    "폭뢰침", "트랩 발동: 대상의 이동속도가 2.5초간 40% 감소합니다\n" +
            ...
            if (falselist[i].name1 == "크레모어") {
                te(
                    "크레모어", "트랩 발동: 좁은 범위로 폭발하며, 피격된 대상은 1초간 기절합니다.\n" +
            ...
            if (falselist[i].name1 == "리모트 마인") {
                te(
                    "리모트 마인", "트랩 발동: 1.5초 후 넓은 범위로 폭발합니다.\n" +
            ...
            if (falselist[i].name1 == "스마트 폭탄") {
                te(
                    "스마트 폭탄", "트랩 발동: 0.7초 후 넓은 범위로 폭발합니다.\n" +
            ...
            if (falselist[i].name1 == "거북이 등딱지") {
                te(
                    "거북이 등딱지", "", "항구(7개), 연못(7개), 모래사장(6개)의 상자\n" +
                            "박쥐(가끔)를 처치", "일반"
                )
            ...
            if (falselist[i].name1 == "원석") {
                te(
                    "우너석", "", "연못(8개), 모래사장(7개), 절(8개), 숲(8개)의 상자\n" +
                            "들개(가끔)를 처치", "일반"
                )
                up("황금", "루비", "무라마사", "", "")
                down("", "", "", "", "")
            ...
            if (falselist[i].name1 == "생명의 나무") {
                te(
                    "생명의 나무", "", "자연 재료 신비한 나무에서 채집(1일 밤 호텔, 2일 낮 숲, 2일 밤 묘지)\n" +
                            "파란색 항공 보급", "희귀"
                )
                up("생명의 가루", "생사부", "", "", "")
                down("", "", "", "", "")
        ...
        return consume.ViewHolder(view).apply {
            imagebutton1.setOnClickListener()
            {
                ...
                for (i in consume_Item.indices) {
                    if (curpos == i) {
                        ImageView1.setImageResource(consume_Item[i].Image1)
                        Log.d("확인", i.toString())
