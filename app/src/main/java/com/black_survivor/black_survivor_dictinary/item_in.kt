...
class item_in(context: Context) {
    ...
    fun falsearray(j: Int) {
        ...
        if (falselist[j].name1 == "일렉트론 블라스터") {
            te("일렉트론 블라스터", "장탄 수: 10발, 공격력 +58, 이동속도 +0.12\n기본 공격 추가 피해 +31", "[제작]\n 베레타 M92F + 이온 전지", "영웅")
            down("베레타 M92F", "이온 전지", "", "", "")
        }
        if (falselist[j].name1 == "매그넘\u002d보아") {
            te("매그넘\u002d보아", "장탄 수: 6발, 공격력 +90, 이동속도 +0.15\n시야 +2.5, 생명력 흡수 +22%", "[제작]\n 매그넘\u002d아나콘다 + 강철", "영웅")
            down("매그넘-아나콘다", "강철", "", "", "")
        }
        ...
        if (falselist[j].name1 == "인터벤션") {
            te("인터벤션", "장탄 수 : 2발, 공격력 +120, 시야 +4, 기본 공격 사거리 +1.5", "[제작]\n 하푼건 + 망원 카메라", "영웅")
            down("하푼건", "망원 카메라", "", "", "")
        }
        ...
        if (falselist[j].name1 == "구원의 여신상") {
            te("구원의 여신상", "공격력 +82, 체력 재생 +0.6, 스태미너 재생 +80%, 공격 속도 +15%, 생명력 흡수 +12%", "[제작]\n횃불 + 인형", "영웅")
            up("", "", "", "", "")
            down("횃불", "인형", "", "", "")
        }
        ...
        if (falselist[j].name1 == "스파이의 우산") {
            te("스파이의 우산", "공격력 +68, 스킬 증폭 +25, 스태미너 재생 +0.8", "[제작]\n우산 + 재", "영웅")
            up("", "", "", "", "")
            down("우산", "재", "", "", "")
        }
        ...
        if (falselist[j].name1 == "페일노트") {
            te("페일노트", "공격력 +105, 공격속도 +15%, 생명력 흡수 +15%", "[제작]\nVF 혈액 샘플 + 강궁", "전설")
            up("", "", "", "", "")
            down("VF 혈액 샘플", "강궁", "", "", "")
        }
        ...
        if (falselist[j].name1 == "풍마 수리검") {
            te("풍마 수리검", "장탄 수: 50, 공격력 +58, 쿨다운 감소 +15%, 기본 공격 추가 피해 +40, 스태미너 재생 + 0.6", "[제작]\n매화비표 + 알코올", "영웅")
            up("", "", "", "", "")
            down("매화비표", "알코올", "", "", "")
        }
        ...
        if (falselist[j].name1 == "피스브링어") {
            te("피스브링어", "공격력 +140, 생명력 흡수 +20%", "[제작]\n사슴 망치 + VF 혈액 샘플", "전설")
            up("", "", "", "", "")
            down("사슴 망치", "VF 혈액 샘플", "", "", "")
        }
        if (falselist[j].name1 == "케르베로스") {
            te("케르베로스", "공격력 +61, 기본공격적중시 치유감소 -40%, 기본공격사거리 +0.5, 이동 속도+0.1", "[제작]\n샤퍼 + 체인 레깅스", "영웅")
            up("", "", "", "", "")
            down("샤퍼", "체인 레깅스", "", "", "")
        }
        ...
        if (falselist[j].name1 == "매버릭 러너") {
            te("매버릭 러너", "공격속도 +10%, 이동속도 +0.3, 비전투중 이동속도 +0.25", "[제작] 힐리스 + 전자 부품\n파란색 항공 보급", "희귀")
            up("", "", "", "", "")
            down("힐리스", "전자 부품", "", "", "")
        }
        ...
        if (falselist[j].name1 == "EOD 부츠") {
            te("EOD 부츠", "방어력 +26, 체력 재생 +1, 스태미너 재생 +0.5, 이동속도 +0.35", "[제작] 부츠 + 강철 무릎 보호대\n노란색 항공 보급", "전설")
            up("", "", "", "", "")
            down("부츠", "강철 무릎 보호대", "", "", "")
        }
