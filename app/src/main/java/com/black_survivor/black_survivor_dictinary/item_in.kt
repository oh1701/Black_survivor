...
class item_in(context: Context) {
    ...
    fun falsearray(i: Int) {
        ...
        if (falselist[i].name1 == "카른웬난") {
            te("카른웬난", "공격력 +41, 이동속도 +0.1, 체력 재생 +1.5\n 쿨다운 감소 +12%, 기본 공격 추가 피해 +29", "[제작] \n 장미칼 + 성자의 유산", "영웅")
            up("장미칼", "성자의 유산", "", "", "")
        }
        ...
        if (falselist[i].name1 == "호푸어드") {
            te("호푸어드", "공격력 +50, 최대체력 +300, 치명타 확률 +20%", "[제작] 보검 + 유리 조각", "영웅")
            down("보검", "유리 조각", "", "", "")
        }
        ...
        if (falselist[i].name1 == "폴라리스") {
            te("폴라리스", "장탄 수 : 3발, 공격력 +135, 시야 +2, 공격속도 +40%, 이동속도 -0.03%", "[제작]\n 레일건 + 백색 가루", "영웅")
            down("레일건", "백색 가루", "", "", "")
        }
        ...
        if (falselist[i].name1 == "듀랜달 Mk2") {
            te("듀랜달 Mk2", "공격력 +55, 시야 +3, 치명타 확률 +10%, 치명타 피해량 +25%, 쿨다운 감소 +10%", "[제작]\n 매화검 + 레이저 포인터", "영웅")
            down("매화검", "레이저 포인터", "", "", "")
        }
        ...
        if (falselist[i].name1 == "청룡언월도") {
            te("청룡언월도", "공격력 +110, 체력 +300, 이동속도 -0.05", "[제작]\n 도끼창 + 철판", "영웅")
            down("도끼창", "철판", "", "", "")
        }
        ...
        if (falselist[i].name1 == "소이탄") {
            te("소이탄", "최대 충전 수 : 50발, 공격력 +75, 공격속도 +50%", "[제작]\n화염병 + 볼 라이트닝", "영웅")
            down("화염병", "볼 라이트닝", "", "", "")
        }
        ...
        if (falselist[i].name1 == "다비드슬링") {
            te("다비드슬링", "최대 충전 수 : 50발, 공격력 +75, 체력재생 +150%, 기본 공격 추가 피해 +27", "[제작]\n슬링 + 성자의 유산", "영웅")
            down("슬링", "성자의 유산", "", "", "")
        }
        ...
        if (falselist[i].name1 == "루테늄 구슬") {
            te("루테늄 구슬", "최대 충전 수 : 50발, 공격력 +80, 스킬 증폭 +27%, 스킬 적중 시 치유 감소 -40%", "[제작]\n가시 탱탱볼 + 황금", "영웅")
            down("가시 탱탱볼", "황금", "", "", "")
        }
        ...
        if (falselist[i].name1 == "디바인 피스트") {
            te("디바인 피스트", "공격력 +50, 이동속도 -0.05, 기본 공격 추가 피해 +33", "[제작]\n벽력귀투 + 십자가", "영웅")
            up("", "", "", "", "")
            down("벽력귀투", "십자가", "", "", "")
        }
        ...
        if (falselist[i].name1 == "미치광이왕의 카드") {
            te("미치광이왕의 카드", "장탄 수: 52, 공격력 +49, 공격속도 +40%, 치명타 확률 +20%", "[제작]\n빈티지 카드 + 이온 전지", "영웅")
            up("", "", "", "", "")
            down("빈티지 카드", "이온 전지", "", "", "")
        }
        ...
        if (falselist[i].name1 == "기사단장의 투구") {
            te("기사단장의 투구", "방어력 +24, 최대 스태미너 +200, 이동속도 +0.1, 쿨다운 감소 +10%, 스킬 피해 감소 +11%", "[제작] 투구 + 고무\n보라색 항공 보급", "영웅")
            up("", "", "", "", "")
            down("투구", "고무", "", "", "")
        }
        ...
        if (falselist[i].name1 == "궁기병의 화살통") {
            te("궁기병의 화살통", "공격력 +10, 공격속도 +30%, 이동속도 +0.1", "[제작] 화살통 + 먼지털이개\n파란색 항공 보급", "희귀")
            up("", "", "", "", "")
            down("화살통", "먼지털이개", "", "", "")
        }
