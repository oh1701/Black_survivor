...
class item_in(context: Context) {
    ...
    fun falsearray(j: Int) {
        ...
        if (falselist[j].name1 == "95식 자동소총") {
            te("95식 자동소총", "장탄 수: 30발, 공격력 +75, 시야 +1.5\n 기본 공격 사거리 +1", "[제작]\nAK-47 + 강철", "영웅")
            down("AK-47", "강철", "", "", "")
        }
        ...
        if (falselist[j].name1 == "듀랜달 Mk2") {
            te("듀랜달 Mk2", "공격력 +53, 시야 +1.5, 생명력 흡수 +8%, 치명타 확률 +12%, 치명타 피해량 +25%, 쿨다운 감소 +6%", "[제작]\n 매화검 + 레이저 포인터", "영웅")
            down("매화검", "레이저 포인터", "", "", "")
        }
        if (falselist[j].name1 == "볼틱레토") {
            te("볼틱레토", "공격력 +47, 공격속도 +45%, 치명타 확률 +10%, 치명타 피해량 +15%, 쿨다운 감소 +6%", "[제작]\n 매화검 + 전자 부품", "영웅")
            down("매화검", "전자 부품", "", "", "")
        }
        ...
        if (falselist[j].name1 == "애각창") {
            te("애각창", "공격력 +108, 이동속도 +0.12", "[제작]\n 강창 + 백색 가루", "영웅")
            down("강창", "백색 가루", "", "", "")
        }
        if (falselist[j].name1 == "장팔사모") {
            te("장팔마소", "공격력 +104, 공격속도 +40%", "[제작]\n 강창 + 이온 전지", "영웅")
            down("강창", "이온 전지", "", "", "")
        }
        ...
        if (falselist[j].name1 == "가시 탱탱볼") {
            te("가시 탱탱볼", "공격력 +45, 스킬 적중 시 치유 감소 -25%", "[제작]\n플러버 + 못", "희귀")
            up("루테늄 구슬", "", "", "", "")
            down("플러버", "못", "", "", "")
        }
        ...
        if (falselist[j].name1 == "안티오크의 수류탄") {
            te("안티오크의 수류탄", "최대 충전 수 : 8발, 공격력 +77, 기본 공격 추가 피해 +100", "[제작]\n고폭 수류탄 + 십자가", "영웅")
            down("고폭 수류탄", "십자가", "", "", "")
        }
        ...
        if (falselist[j].name1 == "루테늄 구슬") {
            te("루테늄 구슬", "최대 충전 수 : 50발, 공격력 +76, 스킬 증폭 +28%, 스킬 적중 시 치유 감소 -25%", "[제작]\n가시 탱탱볼 + 황금", "영웅")
            down("가시 탱탱볼", "황금", "", "", "")
        }
        ...
        if (falselist[j].name1 == "트윈보우") {
            te("트윈보우", "공격력 +74, 공격속도 +55%, 기본 공격 시 치유 감소 -25%, 시야 +1", "[제작]\n강궁 + 컴포지트 보우", "영웅")
            up("", "", "", "", "")
            down("강궁", "컴포지트 보우", "", "", "")
        }
        if (falselist[j].name1 == "엘리멘탈 보우") {
            te("엘리멘탈 보우", "공격력 +60, 이동속도 +0.13, 스킬 증폭 +45, 스킬 적중 시 치유 감소 -25%", "[제작]\n화전 + 백우선", "영웅")
            up("", "", "", "", "")
            down("화전", "백우선", "", "", "")
        }
        ...
        if (falselist[j].name1 == "만천화우") {
            te("만천화우", "장탄 수: 3, 공격력 +85, 치명타 피해량 + 30%, 스킬 증폭 +30, 기본 공격 추가 피해 +150", "[제작]\n빙백은침 + 폭뢰침", "전설")
            up("", "", "", "", "")
            down("빙백은침", "폭뢰침", "", "", "")
        }
        ...
        if (falselist[j].name1 == "건곤권") {
            te("건곤권", "장탄 수: 50, 공격력 +53, 스킬 증폭 +23%", "[제작]\n법륜 + 대나무", "영웅")
            up("", "", "", "", "")
            down("법륜", "대나무", "", "", "")
        }
        if (falselist[j].name1 == "생사부") {
            te("생사부", "장탄 수: 15, 공격력 +80, 스킬 증폭 +25%", "[제작]\n부적 + 생명의 나무", "영웅")
            up("", "", "", "", "")
            down("부적", "생명의 나무", "", "", "")
        }
        ...
        if (falselist[j].name1 == "보헤미안") {
            te("보헤미안", "공격력 +53, 최대 체력 +380, 공격 속도 +20%\n치명타 확률 +20%, 기본 공격 추가 피해 +2", "[제작]\n루비 스페셜 + 트럼프 카드", "영웅")
            up("", "", "", "", "")
            down("루비 스페셜", "트럼프 카드", "", "", "")
        }
        ...
        if (falselist[j].name1 == "새티스팩션") {
            te("새티스팩션", "공격력 +30, 공격속도 +30%, 생명력 흡수 +15%, 기본 공격 추가 피해 +15", "[제작]\n노캐스터 + 돌멩이", "영웅")
            up("", "", "", "", "")
            down("노캐스터", "돌멩이", "", "", "")
        }
        ...
        if (falselist[j].name1 == "미스릴 갑옷") {
            te("미스릴 갑옷", "방어력 +65, 공격속도 +12%, 이동속도 +0.2, 스킬 피해 고정 감소 +14", "[제작] 미스릴 + 가죽 갑옷\n보라색 항공 보급", "미스릴 갑옷")
            up("", "", "", "", "")
            down("미스릴", "가죽 갑옷", "", "", "")
        }
        ...
        if (falselist[j].name1 == "큐브 워치") {
            te("큐브 워치", "방어력 +22, 공격속도 +50%, 쿨다운 감소 + 8%", "[제작] 고장난 시계 + 문스톤\n보란색 항공 보급", "영웅")
            up("", "", "", "", "")
            down("고장난 시계", "문스톤", "", "", "")
        }
        ...
        if (falselist[j].name1 == "스카디의 팔찌") {
            te("스카디의 팔찌", "최대 체력 +200, 최대 스태미너 +250, 체력 재생 +1.5, 스태미너 재생 +1.5, 스킬 증폭 +27", "[제작] 만년빙 + 진홍 팔찌\n노란색 항공 보급", "전설")
            up("", "", "", "", "")
            down("만년빙", "진홍 팔찌", "", "", "")
        }
        ...
        if (falselist[j].name1 == "매버릭 러너") {
            te("매버릭 러너", "공격속도 +5%, 이동속도 +0.25, 비전투중 이동속도 +0.35", "[제작] 힐리스 + 전자 부품\n파란색 항공 보급", "희귀")
            up("", "", "", "", "")
            down("힐리스", "전자 부품", "", "", "")
        }
        ...
        if (falselist[j].name1 == "풍화륜") {
            te("풍화륜", "스태미너 재생 +0.5, 스태미너 재생 +50%, 이동속도 +0.33, 스킬증폭 +12", "[제작] 덧댄 슬리퍼 + 재\n파란색 항공 보급", "희귀")
            up("", "", "", "", "")
            down("덧댄 슬리퍼", "재", "", "", "")
        }
        ...
        if (falselist[j].name1 == "미스릴 부츠") {
            te("미스릴 부츠", "방어력 +20, 공격속도 +12%, 이동속도 +0.5", "[제작] 미스릴 + 체인 레깅스\n보라색 항공 보급", "영웅")
            up("", "", "", "", "")
            down("미스릴", "체인 레깅스", "", "", "")
        }
        ...
        if (falselist[j].name1 == "글레이셜 슈즈") {
            te("글레이셜 슈즈", "체력 재생 +1.5, 스태미너 재생 +1.5, 스태미너 재생 +60%, 이동속도 +0.3, 비전투중 이동속도 +0.35, 스킬증폭 +24", "[제작] 덧댄 슬리퍼 + 만년빙\n노란색 항공 보급", "전설")
            up("", "", "", "", "")
            down("만년빙", "덧댄 슬리퍼", "", "", "")
        }
        ...
        if (falselist[j].name1 == "천사의 고리") {
            te("천사의 고리", "공격력 +35, 방어력 +30, 최대 스태미너 +300, 치명타 피해량 감소 +10%", "[제작]\n머리테 + 포스 코어", "전설")
            up("", "", "", "", "")
            down("머리테", "포스 코어", "", "", "")
        }
