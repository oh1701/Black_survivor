    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): anan.ViewHolder {
       ...
       fun falsearray(i:Int){
            ...
            if (falselist[i].name1 == "카른웬난") {
                te("카른웬난", "공격력 +37, 이동속도 +0.1, 체력 재생 +1.5\n 쿨다운 감소 +10%, 기본 공격 추가 피해 +29", "[제작] \n 장미칼 + 성자의 유산", "영웅")
                up("장미칼", "성자의 유산", "", "", "")
            }
            ...
            if (falselist[i].name1 == "하르페") {
                te("하르페", "공격력 +105, 이동속도 +0.1, 스킬 증폭 +38, 스킬 공격 사거리+0.5, 스킬 적중 시 치유 감소 -40%", "[제작] 사신의 낫 + 백우선", "영웅")
                down("사신의 낫", "백우선", "", "", "")
            }
            ...
            if (falselist[i].name1 == "이천일류") {
                te("이천일류", "공격력 +44, 공격속도 +10%, 생명력 흡수 +18%, 스킬 적중 시 치유 감소 -40%", "[제작] \n피렌체식 쌍검 + 못", "영웅")
                down("피렌체식 쌍검", "못", "", "", "")
            }
            ...
            if (falselist[i].name1 == "방천화극"){
                te("방천화극", "공격력 +88, 이동속도 -0.1, 스킬 적중 시 치유 감소 -40%, 스킬 증폭 +34%", "[제작]\n 도끼창 + 군선", "영웅")
                down("도끼창","군선","","","")
            }
            ...
            if(falselist[i].name1 == "디바인 피스트"){
                te("디바인 피스트","공격력 +46, 이동속도 -0.05, 기본 공격 추가 피해 +33","[제작]\n벽력귀투 + 십자가","영웅")
                up("","","","","")
                down("벽력귀투","십자가","","","")
            }
            ...
            if(falselist[i].name1 == "마이쏙"){
                te("마이쏙","공격력 +50, 방어력 +20, 체력 재생 +100%","[제작]\n 류큐톤파 + 단봉", "영웅")
                down("류큐톤파", "단봉","","","")
            }
            ...
            if(falselist[i].name1 == "풍마 수리검"){
                te("풍마 수리검","장탄 수: 50, 공격력 +48, 쿨다운 감소 +15%, 기본 공격 추가 피해 +36","[제작]\n매화비표 + 알코올","영웅")
                up("","","","","")
                down("매화비표","알코올","","","")
            }
       ...
       /////-----
        ...
        fun Itemarray(e: Int) { if (an_Item[e].name1 == "가위") {
            te("가위", "공격력 +5", "골목길(7개), 병원(6개), 학교(6개)의 상자\n, 박쥐(사냥)", "일반")
            up("King-V", "", "", "", "")
        }
        ...
        return anan.ViewHolder(view).apply {
            imagebutton1.setOnClickListener()
            {
                ...
                for (i in an_Item.indices) {
                    if (curpos == i) {
                        ImageView1.setImageResource(an_Item[i].Image1)
                        Log.d("확인", i.toString())
