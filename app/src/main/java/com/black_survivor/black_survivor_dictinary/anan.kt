...
<<<<<<< HEAD
       ...
       /////-----
        ...
        fun Itemarray(e: Int) {
            ...
            item.te("채찍", "공격력 +12", "성당(3개), 학교(3개)의 상자", "일반")
            item.up("오랏줄", "철편", "", "", "")
        }
            ...
            if (an_Item[e].name1 == "메스") {
                item.te("메스", "공격력 +18", "[제작] \n만년필 + 면도칼", "고급")
                item.up("스위스 아미 나이프", "", "", "", "")
            }

            if (an_Item[e].name1 == "스위스 아미 나이프") {
                item.te("스위스 아미 나이프", "공격력 +23, 체력 +100", "[제작] \n메스 + 가위", "희귀")
                item.up("다마스커스 가시", "", "", "", "")
                item.down("메스","가위","","","")
            }

            if (an_Item[e].name1 == "다마스커스 가시") {
                item.te("다마스커스 가시", "공격력 +66, 최대 체력 +250, 스킬 적중 시 치유 감소 -40%", "[제작] \n스위스 아미 나이프 + 가시 발판", "영웅")
                item.down("스위스 아미 나이프", "가시 발판", "", "", "")
            }
            if (an_Item[e].name1 == "가위") {
                item.te("가위", "공격력 +5", "골목길(7개), 병원(6개), 학교(8개)의 상자\n, 박쥐(사냥)", "일반")
                item.up("King-V", "스위스 아미 나이프", "", "", "")
            }

            if (an_Item[e].name1 == "만년필") {
                item.te("만년필", "공격력 +5", "고급 주택가(6개), 번화가(8개), 학교(8개)의 상자\n" + ", 멧돼지(사냥)", "고급")
                item.up("정교한 도면", "싸인볼", "빈티지 카드", "메스", "")
            }

            if (an_Item[e].name1 == "식칼") {
                item.te("식칼", "공격력 +4" + "이동속도 +0.05", "단검 사용 시 기본 지급, 골목길(5개), 호텔(4개), 절(6개)의 상자\n,항구(4개) 멧돼지(사냥)", "일반")
                item.up("군용 나이프", "쌍칼", "바이던트", "해적의 증표", "")
            }

            if (an_Item[e].name1 == "군용 나이프") {
                item.te("군용 나이프", "공격력 +14, 이동속도 +0.08", "[제작] \n 식칼 + 나뭇가지", "고급")
                item.up("장미칼", "초진동나이프", "프라가라흐", "", "")
                item.down("식칼","나뭇가지","","","")
            }
            if (an_Item[e].name1 == "장미칼") {
                item.te("장미칼", "공격력 +20, 이동속도 +0.1, 쿨다운 감소 +8%", "[제작] \n 군용 나이프 + 꽃", "고급")
                item.up("카른웬난", "파산검", "군용 나이프", "꽃", "")
                item.down("군용 나이프","꽃","","","")
            }
            if (an_Item[e].name1 == "카른웬난") {
                item.te("카른웬난", "공격력 +41, 이동속도 +0.1, 체력 재생 +1.2\n 쿨다운 감소 +12%, 기본 공격 추가 피해 +29", "[제작] \n 장미칼 + 성자의 유산", "영웅")
                item.down("장미칼", "성자의 유산", "", "", "")
            }
            if (an_Item[e].name1 == "파산검") {
                item.te("파산검", "공격력 +35, 이동속도 +0.1 \n쿨다운 감소 +15%, 스킬 증폭 +30", "[제작] \n 장미칼 + 재", "영웅")
                item.down("장미칼", "재", "", "", "")
            }
            if (an_Item[e].name1 == "초진동나이프") {
                item.te("초진동나이프", "공격력 +55, 공격속도 +40%, 이동속도 +0.1", "[제작] \n 군용 나이프 + 모터", "영웅")
                item.down("군용 나이프", "모터", "", "", "")
            }
            if (an_Item[e].name1 == "프라가라흐") {
                item.te("프라가라흐", "공격력 +85, 이동속도 +0.22", "[제작] \n 군용 나이프 + 포스 코어", "전설")
                item.down("군용 나이프", "포스 코어", "", "", "")
            }
            ...
            if (an_Item[e].name1 == "모노호시자오") {
                item.te("모노호시자오", "공격력 +80, 생명력 흡수 +25%", "[제작] 무라마사 + 정교한 도면", "영웅")
                item.down("무라마사", "정교한 도면", "", "", "")
            }
            if (an_Item[e].name1 == "호푸어드") {
                item.te("호푸어드", "공격력 +50, 최대체력 +300, 치명타 확률 +28%", "[제작] 보검 + 유리 조각", "영웅")
                item.down("보검", "유리 조각", "", "", "")
            }
            if (an_Item[e].name1 == "레바테인") {
                item.te("레바테인", "공격력 +78, 체력 재생 +2.0, 스태미너 재생 +2.0, 기본공격 추가 피해 +25, 공격속도 +10%", "[제작] 삼매진화 + 샴쉬르", "전설")
                item.down("삼매진화", "샴쉬르", "", "", "")
            }
            if (an_Item[e].name1 == "다인슬라이프") {
                item.te("다인슬라이프", "공격력 +83, 기본 공격 시 치유 감소 - 40%, 생명력 흡수 +25%", "[제작] VF 혈액 샘플 + 일본도", "전설")
            ...
            if (an_Item[e].name1 == "경량화 도끼") {
                item.te("경량화 도끼", "공격력 +61, 이동속도 +0.05", "[제작] \n 전투 도끼 + 깃털", "희귀")
                item.up("파라슈", "", "", "", "")
                item.down("전투 도끼", "깃털", "", "", "")
            }
            ...
            if (an_Item[e].name1 == "빔 엑스") {
                item.te("빔 엑스", "공격력 +127, 시야 +3.5", "[제작] \n대부 + 레이저 포인터", "영웅")
                item.down("대부", "레이저 포인터", "", "", "")
            }
            if (an_Item[e].name1 == "산타 무에르테") {
                item.te("산타 무에르테", "공격력 +100, 최대 체력 +365 ,생명력 흡수 +15%\n기본 공격 사거리 +0.5", "[제작] \n사신의 낫 + 루비", "영웅")
                item.down("사신의 낫", "루비", "", "", "")
            }
            if (an_Item[e].name1 == "스퀴테") {
                item.te("스퀴테", "공격력 +112, 기본 공격 사거리 +1 \n 스킬 증폭 +20%", "[제작] \n사신의 낫 + 황금", "영웅")
                item.down("사신의 낫", "황금", "", "", "")
            }
            if (an_Item[e].name1 == "파라슈") {
                item.te("파라슈", "공격력 +115, 이동속도 +0.07, 쿨다운 감소 +10%", "[제작] 경량화 도끼 + 진신사리", "영웅")
                item.down("경량화 도끼", "진신사리", "", "", "")
            }
            if (an_Item[e].name1 == "하르페") {
                item.te("하르페", "공격력 +105, 이동속도 +0.07, 스킬 증폭 +33, 스킬 공격 사거리+0.5, 스킬 적중 시 치유 감소 -40%", "[제작] 사신의 낫 + 백우선", "영웅")
                item.down("사신의 낫", "백우선", "", "", "")
            }
            ...
            if (an_Item[e].name1 == "이천일류") {
                item.te("이천일류", "공격력 +46, 공격속도 +12%, 생명력 흡수 +20%, 스킬 적중 시 치유 감소 -40%", "[제작] \n피렌체식 쌍검 + 못", "영웅")
                item.down("피렌체식 쌍검", "못", "", "", "")
            }
            if (an_Item[e].name1 == "자웅일대검") {
                item.te("자웅일대검", "공격력 +60, 공격속도 +40%, 기본공격 추가피해 +8", "[제작] \n쌍칼 + 문스톤", "영웅")
                item.down("쌍칼", "문스톤", "", "", "")
            }
            if (an_Item[e].name1 == "디오스쿠로이") {
                item.te("디오스쿠로이", "공격력 +48, 공격속도 +50%", "[제작] \n쌍칼 + 이온 전지", "영웅")
                item.down("쌍칼", "이온 전지", "", "", "")
            }
            if (an_Item[e].name1 == "로이거 차르") {
                item.te("로이거 차르", "공격력 +38, 공격속도 +20%, 스킬 증폭 +36", "[제작] \n쌍칼 + 독약", "영웅")
                item.down("쌍칼", "독약", "", "", "")
            }
            if (an_Item[e].name1 == "발터 PPK\u002dMagnum") {
                item.te("발터 PPK", "장탄 수: 6발, 공격력 +14", "사용 시 기본 지급\n" + "모래사장(4개), 호텔(5개), 공장(4개)의 상자", "일반")
                item.up("매그넘-파이썬", "베레타 M92F", "캐리비안 장식총", "", "")
            }
            ...
            if (an_Item[e].name1 == "일렉트론 블라스터") {
                item.te("일렉트론 블라스터", "장탄 수: 10발, 공격력 +61, 이동속도 +0.12\n기본 공격 추가 피해 +31", "[제작]\n 베레타 M92F + 이온 전지", "영웅")
                item.down("베레타 M92F", "이온 전지", "", "", "")
            }
            if (an_Item[e].name1 == "매그넘\u002d보아") {
                item.te("매그넘\u002d보아", "장탄 수: 7발, 공격력 +90, 이동속도 +0.15\n시야 +2.5, 생명력 흡수 +22%", "[제작]\n 매그넘\u002d아나콘다 + 강철", "영웅")
                item.down("매그넘-아나콘다", "강철", "", "", "")
            }
            if (an_Item[e].name1 == "악켈테") {
                item.te("악켈테", "장탄 수: 10발, 공격력 +115, 이동속도 +0.2, 시야 +2", "[제작]\n 포스 코어 + 베레타 M92F", "전설")
            ...
            if (an_Item[e].name1 == "개틀링 건") {
                item.te("개틀링 건", "장탄 수: 30발, 공격력 +20, 시야 +1.5\n 기본 공격 추가 피해 +11, 공격 속도 +10%", "[제작]\nSTG\u002d44 + 모터", "영웅")
                item.down("STG-44", "모터", "", "", "")
            }
            if (an_Item[e].name1 == "AK\u002d12") {
                item.te("AK\u002d12", "장탄 수: 30발, 공격력 +89, 시야 +1.5\n 치명타 확률 20%", "[제작]\nAK-47 + 유리판", "영웅")
                item.down("AK-47", "유리판", "", "", "")
            }
            ...
            if (an_Item[e].name1 == "Tac\u002d50") {
                item.te("Tac\u002d50", "장탄 수 : 2발, 공격력 +128, 시야 +2.5, 생명력 흡수 +20%", "[제작]\n 하푼건 + 정교한 도면", "영웅")
                item.down("하푼건", "정교한 도면", "", "", "")
            }
            if (an_Item[e].name1 == "인터벤션") {
                item.te("인터벤션", "장탄 수 : 2발, 공격력 +120, 시야 +5, 기본 공격 사거리 +1.5", "[제작]\n 하푼건 + 망원 카메라", "영웅")
                item.down("하푼건", "망원 카메라", "", "", "")
            }
            if (an_Item[e].name1 == "NTW\u002d20") {
                item.te("NTW\u002d20", "장탄 수 : 1발, 공격력 +92, 시야 +2.5, 이동속도 -0.07, 스킬증폭 +24%", "[제작]\n 금교전 + 철판", "영웅")
                item.down("금교전", "철판", "", "", "")
            }
            if (an_Item[e].name1 == "폴라리스") {
                item.te("폴라리스", "장탄 수 : 4발, 공격력 +110, 시야 +2, 공격속도 +35%", "[제작]\n 레일건 + 백색 가루", "영웅")
                item.down("레일건", "백색 가루", "", "", "")
            }

            if (an_Item[e].name1 == "사사성광") {
                item.te("사사성광", "장탄 수 : 2발, 공격력 +100, 시야 +2.5, 이동속도 -0.03, 스킬증폭 +33%", "[제작]\n 문스톤 + 금교전", "전설")
                item.down("문스톤", "금교전", "", "", "")
            }
            ...
            if (an_Item[e].name1 == "활빈검") {
                item.te("활빈검", "공격력 +30, 시야 +1, 체력 재생+1.5, 스태미너 재생 +150%, 쿨다운 감소 +12% 치명타 피해량 +25%", "[제작] \n레이피어 + 어사의", "영웅")
                item.up("미스틸테인", "", "", "", "")
                item.down("레이피어", "어사의", "", "", "")
            }
            ...
            if (an_Item[e].name1 == "파이크") {
                item.te("파이크", "공격력 +53, 이동속도 -0.1", "[제작]\n 단창 + 강철", "희귀")
            ...
            if (an_Item[e].name1 == "방천화극") {
                item.te("방천화극", "공격력 +84, 이동속도 -0.07, 스킬 적중 시 치유 감소 -40%, 스킬 증폭 +31%", "[제작]\n 도끼창 + 군선", "영웅")
                item.down("도끼창", "군선", "", "", "")
            }
            if (an_Item[e].name1 == "청룡언월도") {
                item.te("청룡언월도", "공격력 +118, 체력 +320, 이동속도 -0.05", "[제작]\n 도끼창 + 철판", "영웅")
                item.down("도끼창", "철판", "", "", "")
            }
            if (an_Item[e].name1 == "화첨창") {
                item.te("화첨창", "공격력 +115, 체력 재생 +2, 스태미너 재생 +2, 기본 공격 추가 피해 +33", "[제작]\n 삼매진화 + 죽창", "전설")
                item.down("삼매진화", "죽창", "", "", "")
            }

            if (an_Item[e].name1 == "롱기누스의 창") {
                item.te("롱기누스의 창", "공격력 +130, 생명력 흡수 +20%", "[제작]\n VF 혈액 샘플 + 파이크", "전설")
            ...
            if (an_Item[e].name1 == "낭아봉") {
                item.te("낭아봉", "공격력 +55, 스킬 증폭 +33", "[제작]\n모닝 스타 + 달궈진 돌멩이", "영웅")
                item.down("모닝 스타", "달궈진 돌멩이", "", "", "")
            }
            if (an_Item[e].name1 == "다그다의 망치") {
                item.te("다그다의 망치", "공격력 +95, 체력 재생 +200%, 기본공격 추가 피해 +22", "[제작]\n사슴 망치 + 성자의 유산", "영웅")
            ...
            if (an_Item[e].name1 == "개밥바라기") {
                item.te("개밥바라기", "공격력 +137", "[제작]\n 문스톤 + 모닝 스타", "영웅")
                item.down("문스톤", "모닝 스타", "", "", "")
            }
            if (an_Item[e].name1 == "마법봉") {
                item.te("마법봉", "공격력 +60, 생명력 흡수 +30%, 시야 +0.5, 스킬 증폭 +27%", "[제작]\n 워해머 + 달빛 펜던트", "영웅")
                item.down("워해머", "달빛 펜던트", "", "", "")
            }
            if (an_Item[e].name1 == "쇠구슬") {
                item.te("쇠구슬", "장탄 수: 50, 공격력 +12", "양궁장(6개), 숲(7개), 공장(7개)의 상자\n" +
                        "맷돼지(사냥)", "일반")
            ...
            if (an_Item[e].name1 == "소이탄") {
                item.te("소이탄", "최대 충전 수 : 50발, 공격력 +66, 쿨다운 감소 +10%, 공격속도 +60%", "[제작]\n화염병 + 볼 라이트닝", "영웅")
            ...
            if (an_Item[e].name1 == "다비드슬링") {
                item.te("다비드슬링", "최대 충전 수 : 50발, 공격력 +68, 체력재생 +200%, 기본 공격 추가 피해 +33", "[제작]\n슬링 + 성자의 유산", "영웅")
                item.down("슬링", "성자의 유산", "", "", "")
            }
            if (an_Item[e].name1 == "연막탄") {
                item.te("연막탄", "최대 충전 수 : 24발, 공격력 +85, 공격속도 +40%", "[제작]\n밀가루 폭탄 + 콜라", "영웅")
                item.down("밀가루 폭탄", "콜라", "", "", "")
            }
            ...
            if (an_Item[e].name1 == "건틀릿") {
                item.te("건틀릿", "공격력 +28, 이동속도 -0.1", "[제작]\n목장갑 + 강철", "희귀")
                item.up("귀골 장갑", "벽력귀투", "", "", "")
                item.down("목장갑", "강철", "", "", "")
            }
            ...
            if (an_Item[e].name1 == "귀골 장갑") {
                item.te("귀골 장갑", "공격력 +35, 방어력 +13, 이동속도 -0.07", "[제작]\n건틀릿 + 거북이 등딱지", "희귀")
            ...
            if (an_Item[e].name1 == "단영촌천투") {
                item.te("단영촌천투", "공격력 +50, 방어력 +18, 스태미너 재생 +50%, 생명력 흡수 +12%", "[제작]\n귀골 장갑 + 인형", "영웅")
                item.up("", "", "", "", "")
                item.down("귀골 장갑", "인형", "", "", "")
            }

            if (an_Item[e].name1 == "디바인 피스트") {
                item.te("디바인 피스트", "공격력 +55, 이동속도 -0.1, 기본 공격 추가 피해 +39", "[제작]\n벽력귀투 + 십자가", "영웅")
                item.up("", "", "", "", "")
                item.down("벽력귀투", "십자가", "", "", "")
            }

            if (an_Item[e].name1 == "블러드윙 너클") {
                item.te("블러드윙 너클", "공격력 +53, 최대 체력 +210, 이동속도 +0.1", "[제작]\n윙 너클 + 루비", "영웅")
                item.up("", "", "", "", "")
                item.down("윙 너클", "루비", "", "", "")
            }

            if (an_Item[e].name1 == "빙화현옥수") {
                item.te("빙화현옥수", "공격력 +35, 쿨다운 감소 +15%, 스킬 증폭 +38", "[제작]\n회단 장갑 + 얼음", "영웅")
                item.up("", "", "", "", "")
                item.down("회단 장갑", "얼음", "", "", "")
            }
            if (an_Item[e].name1 == "여래수투") {
                item.te("여래수투", "공격력 +43, 쿨다운 감소 +19% 스킬 증폭 +19%", "[제작]\n회단 장갑 + 진신사리", "영웅")
                item.up("", "", "", "", "")
                item.down("회단 장갑", "진신사리", "", "", "")
            }

            if (an_Item[e].name1 == "브레이질 건틀릿") {
                item.te("브레이질 건틀릿", "공격력 +50, 방어력 +10, 체력 재생 +1.2, 스태미너 재생 +1.2, 공격 속도 +35%, 이동속도 -.0.05", "[제작]\n귀골 장갑 + 기름먹인 천 ", "영웅")
                item.up("", "", "", "", "")
            ...
            if (an_Item[e].name1 == "천잠장갑") {
                item.te("천잠장갑", "공격력 +88, 이동속도 +0.22", "[제작]\n미스릴 실 + 글러브", "영웅")
                item.up("", "", "", "", "")
                item.down("미스릴 실", "글러브", "", "", "")
            }
...
<<<<<<< HEAD
            ...
            if (an_Item[e].name1 == "택티컬 톤파") {
                item.te("택티컬 톤파", "공격력 +74, 방어력 +16, 생명력 흡수 +25%", "[제작]\n 경찰봉 + 정교한 도면", "영웅")
                item.down("경찰봉 + 정교한 도면", "", "", "", "")
            }
            if (an_Item[e].name1 == "마이쏙") {
                item.te("마이쏙", "공격력 +63, 방어력 +25, 체력 재생 +100%", "[제작]\n 류큐톤파 + 단봉", "영웅")
                item.down("류큐톤파", "단봉", "", "", "")
            }
            if (an_Item[e].name1 == "플라즈마 톤파") {
                item.te("플라즈마 톤파", "공격력 +65, 방어력 +24, 시야 +2.5", "[제작]\n류큐톤파 + 레이저 포인터", "영웅")
            ...
            if (an_Item[e].name1 == "장봉") {
                item.te("장봉", "공격력 +22", "[제작]\n단봉 + 대나무", "고급")
                item.up("도깨비 방망이", "우산", "여의봉", "", "")
                item.down("단봉", "대나무", "", "", "")
            }

            if (an_Item[e].name1 == "도깨비 방망이") {
                item.te("도깨비 방망이", "공격력 +27, 기본 공격 시 치유 감소 -40%", "[제작]\n장봉 + 못", "희귀")
                item.up("타구봉", "", "", "", "")
                item.down("장봉", "못", "", "", "")
            }
            ...
            if (an_Item[e].name1 == "횃불") {
                item.te("횃불", "공격력 +36, 체력 재생 +0.5, 공격 속도 +10%", "[제작]\n단봉 + 기름먹인 천", "희귀")
                item.up("구원의 여신상", "", "", "", "")
                item.down("단봉", "기름먹인 천", "", "", "")
            }

            if (an_Item[e].name1 == "구원의 여신상") {
                item.te("구원의 여신상", "공격력 +78, 체력 재생 +0.6, 스태미너 재생 +80%, 공격 속도 +15%, 생명력 흡수 +12%", "[제작]\n횃불 + 인형", "영웅")
                item.up("", "", "", "", "")
                item.down("횃불", "인형", "", "", "")
            }
            if (an_Item[e].name1 == "타구봉") {
                ...
                item.up("", "", "", "", "")
                item.down("도깨비 방망이", "전자 부품", "", "", "")
            }
            if (an_Item[e].name1 == "스파이의 우산") {
                item.te("스파이의 우산", "공격력 +65, 스킬 증폭 +30, 스태미너 재생 +0.8", "[제작]\n우산 + 재", "영웅")
                item.up("", "", "", "", "")
                item.down("우산", "재", "", "", "")
            }
            if (an_Item[e].name1 == "여의봉") {
                item.te("여의봉", "공격력 +140", "[제작]\n포스 코어 + 장봉", "전설")
                item.up("", "", "", "", "")
                item.down("포스 코어", "장봉", "", "", "")
            }
            ...
            if (an_Item[e].name1 == "골든래쇼 보우") {
                item.te("골든래쇼 보우", "공격력 +68, 쿨다운 감소 +15%, 스킬 증폭 +20%", "[제작]\n탄궁 + 황금", "영웅")
                item.up("", "", "", "", "")
                item.down("탄궁", "황금", "", "", "")
            }
            ...
            if (an_Item[e].name1 == "석궁") {
                item.te("석궁", "공격력 +12, 스킬 증폭 +8%", "사용 시 기본 지급\n" +
                        "숲(4개), 공장(3개)의 상자", "일반")
                item.up("쇠뇌", "크로스보우", "", "", "")
                item.down("", "", "", "", "")
            }
            ...
            if (an_Item[e].name1 == "헤비 크로스보우") {
                item.te("헤비 크로스보우", "공격력 +66, 이동 속도 -0.1", "[제작]\n쇠뇌 + 강철", "희귀")
                item.up("발리스타", "", "", "", "")
                item.down("쇠뇌", "강철", "", "", "")
            }
            ...
            if (an_Item[e].name1 == "저격 크로스보우") {
                item.te("저격 크로스보우", "공격력 +85, 시야 +3\n" +
                        "기본 공격 사거리 +1", "[제작]\n저격궁 + 저격 스코프", "영웅")
                item.up("", "", "", "", "")
                item.down("저격궁", "저격 스코프", "", "", "")
            }
            if (an_Item[e].name1 == "영광금귀신기노") {
                item.te("영광금귀신기노", "공격력 +66\n" +
                        "기본 공격 추가 피해 +44", "[제작]\n노 + RDX", "영웅")
                item.up("", "", "", "", "")
                item.down("노", "RDX", "", "", "")
            }
            if (an_Item[e].name1 == "샤릉가") {
                item.te("샤릉가", "공격력 +140, 시야 +1.5", "[제작]\n포스 코어 + 크로스보우", "전설")
                item.up("", "", "", "", "")
                item.down("포스 코어", "크로스보우", "", "", "")
            }
            if (an_Item[e].name1 == "면도칼") {
                item.name.text = "면도칼"
                item.abil.text = "공격력 +11"
                item.exeplan.text = "사용 시 기본 지급\n 병원, 성당, 학교의 상자 ,박쥐(사냥)"
                item.grade.text = "일반"
                item.im.text = "상위 아이템1 (터치 시 상위 아이템2로 변경)"
                item.im.isClickable = true
            ...
            if (an_Item[e].name1 == "분필") {
                item.te("분필", "장탄 수: 50, 공격력 +12", "공장, 성당, 학교의 상자\n" +
                        "박쥐(사냥)", "일반")
                item.up("백색 가루", "", "", "", "")
                item.down("", "", "", "", "")
            }
            ...
            if (an_Item[e].name1 == "다트") {
                item.te("다트", "장탄 수: 20, 공격력 +16, 치명타 피해량 +15%, 이동 속도 +0.1%", "[제작]\n바늘 + 깃털", "고급")
                item.up("플럼바타", "", "", "", "")
                item.down("바늘", "깃털", "", "", "")
            }
            if (an_Item[e].name1 == "빈티지 카드") {
            ...
            if (an_Item[e].name1 == "플럼바타") {
                item.te("플럼바타", "장탄 수: 20, 공격력 +48, 이동속도 +0.18, 치명타 피해량 +15%", "[제작]\n다트 + 강철", "희귀")
                item.up("플레셋", "", "", "", "")
                item.down("다트", "강철", "", "", "")
            }
            if (an_Item[e].name1 == "미치광이왕의 카드") {
                item.te("미치광이왕의 카드", "장탄 수: 52, 공격력 +49, 치명타 피해 증가 +10%, 공격속도 +40%, 치명타 확률 +25%", "[제작]\n빈티지 카드 + 이온 전지", "영웅")
                item.up("", "", "", "", "")
                item.down("빈티지 카드", "이온 전지", "", "", "")
            }
            if (an_Item[e].name1 == "옥전결") {
                item.te("옥전결", "장탄 수: 12, 공격력 +60, 스킬 증폭 +15", "[제작]\n부적 + 재", "영웅")
                item.up("", "", "", "", "")
                item.down("부적", "재", "", "", "")
            }
            if (an_Item[e].name1 == "풍마 수리검") {
                item.te("풍마 수리검", "장탄 수: 50, 공격력 +58, 쿨다운 감소 +15%, 기본 공격 추가 피해 +40", "[제작]\n매화비표 + 알코올", "영웅")
                item.up("", "", "", "", "")
                item.down("매화비표", "알코올", "", "", "")
            }
            if (an_Item[e].name1 == "빙백은침") {
            ...
            if (an_Item[e].name1 == "푸른색 단도") {
                item.te("푸른색 단도", "장탄 수: 50, 공격력 +20, 기본 공격 추가 피해 +33, 스킬 증폭 +24", "[제작]\n흑건 + 독약", "영웅")
                item.up("", "", "", "", "")
                item.down("흑건", "독약", "", "", "")
            }
            if (an_Item[e].name1 == "플레셋") {
                item.te("플레셋", "장탄 수: 24, 공격력 +85, 이동속도 +0.25, 치명타 피해량 +15%, 기본 공격 사거리 +0.5", "[제작]\n플럼바타 + 백색 가루", "")
                item.up("", "", "", "", "")
            ...
            if (an_Item[e].name1 == "천국의 계단") {
                item.te("천국의 계단", "공격력 +66, 쿨다운 감소 +5%, 체력 재생 +200%, 시야 +3, 스킬 증폭 +18%", "[제작] 험버커 픽업 + 성배\n보라색 항공 보급 ", "영웅")
                item.up("", "", "", "", "")
                item.down("험버커 픽업", "성배", "", "", "")
            }
            ...
            if (an_Item[e].name1 == "원더풀 투나잇") {
                item.te("원더풀 투나잇", "공격력 +92, 공격속도 +25%, 기본 공격 추가 피해 +2", "[제작]\n슈퍼스트랫 + 운석", "영웅")
                item.up("", "", "", "", "")
                item.down("슈퍼스트랫", "운석", "", "", "")
            }
            ...
            if (an_Item[e].name1 == "틴 스피릿") {
                item.te("틴 스피릿", "공격력 +10, 기본 공격 사거리 +1, 공격속도 +30%, 기본 공격 추가 피해 +22", "[제작]\n야생마 + 진신사리", "영웅")
                item.up("", "", "", "", "")
                item.down("야생마", "진신사리", "", "", "")
            }
...
<<<<<<< HEAD
            ...
            if (an_Item[e].name1 == "대소반룡곤") {
                item.te("대소반룡곤", "공격력 +50, 스킬증폭 +20, 스킬 적중 시 치유 감소 -40%", "[제작]\n샤퍼 + 재", "영웅")
                item.up("", "", "", "", "")
                item.down("샤퍼", "재", "", "", "")
            }
