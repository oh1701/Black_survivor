...
class skill_information : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intent.hasExtra("아야")) {
            ...
            binding.rExeplan2.text = "피해량 : 200/350/500(+0.7 공격력)\n" +
                    "사정거리 : 4.5m\n" +
                    "스테미너 소모 : 100\n" +
                    "시전 시간 : 1.17초\n" +
                    "제압 지속 시간 : 1.5/1.75/2초\n" +
                    "쿨다운 : 100/70/40초"
        ...
        if (intent.hasExtra("아드리아나")) {
            ...
            binding.eExeplan1.text = "아드리아나가 지정한 방향으로 돌진합니다.\n" +
                    "아드리아나가 이동한 경로에 2초 간 유지되는 화염지대가 생성됩니다."
        ...
        if (intent.hasExtra("아이솔")) {
            ...
            binding.qExeplan1.text = "아이솔이 적이나 지면에 부착되는 폭탄을 던집니다.\n" +
                    ...
                    "셈텍스 폭탄이 지면에 닿을때 폭탄 중심에 적이 1.6m 이내에 있으면 폭탄은 적에게 달라붙고 6초 뒤에 터지면서 1초 동안 속박을 줍니다\n" +
            ...
            binding.wExeplan2.text = "피해량 : 20/30/40/50/60(+0.6 공격력)x4\n" +
                    "이동 속도 감소 : 15%\n" +
                    "사정거리 : 6m\n" +
                    "스테미너 소모 : 70/85/100/115/130\n" +
                    "지속 시간 : 2초\n" +
        ...
        if (intent.hasExtra("쇼우")) {
            ...
            binding.rExeplan2.text = "피해량 : 30/80/130(+0.5 공격력)+(패시브 스택 x1)\n" +
                    "사정거리 : 6.5m(90도 범위)\n" +
                    "체력 소모 : 100/120/140\n" +
                    "지속 시간 : 3초\n" +
                    "쿨다운 : 60초"
        ...
        if (intent.hasExtra("엠마")) {
            ...
            binding.qExeplan2.text = "피해량 : 40/75/110/145/180(+0.45 공격력)\n" +
                    "비둘기 유지 시간 : 10초\n" +
                    "이동속도 감소 : 30%\n" +
                    "사정거리 : 10m\n" +
                    "스태미너 소모 : 110\n" +
