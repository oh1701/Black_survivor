...
class in_intem:AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val ImageView1: ImageView = findViewById(R.id.im1)

        val name: TextView = findViewById(R.id.te1)

        val uptext1: TextView = findViewById(R.id.imup_text1)
        val uptext2: TextView = findViewById(R.id.imup_text2)
        val uptext3: TextView = findViewById(R.id.imup_text3)
        val uptext4: TextView = findViewById(R.id.imup_text4)
        val uptext5: TextView = findViewById(R.id.imup_text5)
        val im: TextView = findViewById(R.id.te4)

        val downtext1: TextView = findViewById(R.id.imdown_text1)
        val downtext2: TextView = findViewById(R.id.imdown_text2)
        val downtext3: TextView = findViewById(R.id.imdown_text3)
        val downtext4: TextView = findViewById(R.id.imdown_text4)
        val downtext5: TextView = findViewById(R.id.imdown_text5)

        val imaup1: ImageView = findViewById(R.id.imup_1)
        val imaup2: ImageView = findViewById(R.id.imup_2)
        val imaup3: ImageView = findViewById(R.id.imup_3)
        val imaup4: ImageView = findViewById(R.id.imup_4)
        val imaup5: ImageView = findViewById(R.id.imup_5)

        val imadown1: ImageView = findViewById(R.id.imdown_1)
        val imadown2: ImageView = findViewById(R.id.imdown_2)
        val imadown3: ImageView = findViewById(R.id.imdown_3)
        val imadown4: ImageView = findViewById(R.id.imdown_4)
        val imadown5: ImageView = findViewById(R.id.imdown_5)

        val grade: TextView = findViewById(R.id.te2_1)
        val abil: TextView = findViewById(R.id.te22_1)
        val exeplan: TextView = findViewById(R.id.te3_1)

        val imsi: ImageView = findViewById(R.id.imaging)
        val noimage: ImageView = findViewById(R.id.imaging2)
