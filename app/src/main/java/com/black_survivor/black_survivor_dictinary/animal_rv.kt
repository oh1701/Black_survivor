...
<<<<<<< HEAD
            ...
            if (falselist[i].name1 == "플라즈마 윕") {
                te("플라즈마 윕", "공격력 +60, 공격 속도 +30%\n" +
                        "시야 +2.3, 기본 공격 추가피해 +12", "[제작] 박력편 + 레이저 포인터", "영웅")
                up("", "", "", "", "")
                down("박력편", "레이저 포인터", "", "", "")
            }
            if (falselist[i].name1 == "혈화구절편") {
                te("혈화구절편", "공격력 +65, 생명력 흡수 +25%\n" +
...
<<<<<<< HEAD
                te("만년필", "공격력 +5", "고급 주택가(6개), 번화가(8개), 학교(7개)의 상자\n" + ", 멧돼지(사냥)", "고급")
=======
...
=======
            ...
            if (falselist[i].name1 == "카른웬난") {
                te("카른웬난", "공격력 +30, 이동속도 +0.1, 체력 재생 +1.5\n 쿨다운 감소 +10%, 기본 공격 추가 피해 +29", "[제작] \n 장미칼 + 성자의 유산", "영웅")
                up("장미칼", "성자의 유산", "", "", "")
            }
            if (falselist[i].name1 == "파산검") {
                te("파산검", "공격력 +33, 이동속도 +0.1 \n쿨다운 감소 +10%, 스킬 증폭 +35", "[제작] \n 장미칼 + 재", "영웅")
                up("장미칼", "재", "", "", "")
            }
            if (falselist[i].name1 == "초진동나이프") {
                te("초진동나이프", "공격력 +57, 공격속도 +30%, 이동속도 +0.1", "[제작] \n 군용 나이프 + 모터", "영웅")
                up("군용 나이프", "모터", "", "", "")
            }
            if (falselist[i].name1 == "프라가라흐") {
                te("프라가라흐", "공격력 +75, 이동속도 +0.2", "[제작] \n 군용 나이프 + 포스 코어", "전설")
                up("군용 나이프", "포스 코어", "", "", "")
            }
            if (falselist[i].name1 == "녹슨 검") {
                te("녹슨 검", "공격력 + 11", "양손검 사용 시 기본 지급\n" + "항구(4개), 절(4개), 성당(4개)의 상자", "일반")
                up("샴쉬르", "일본도", "바스타드 소드", "쌍검", "")
>>>>>>> origin/master
            }
...
=======
                te("뚜언 띠엔", "공격력 +77, 방어력 +25, 이동속도 -0.1", "[제작] 바스타드 소드 + 거북이 등딱지", "희귀")
>>>>>>> origin/master
...
<<<<<<< HEAD
            ...
            if (falselist[i].name1 == "모노호시자오") {
                te("모노호시자오", "공격력 +77, 생명력 흡수 +25%", "[제작] 무라마사 + 정교한 도면", "영웅")
                down("무라마사", "정교한 도면", "", "", "")
            }
            ...
            if (falselist[i].name1 == "레바테인") {
                te("레바테인", "공격력 +78, 체력 재생 +2.0, 스태미너 재생 +2.0, 기본공격 추가 피해 +20, 공격속도 +8%", "[제작] 삼매진화 + 샴쉬르", "전설")
                down("삼매진화", "샴쉬르", "", "", "")
            }
            if (falselist[i].name1 == "다인슬라이프") {
                te("다인슬라이프", "공격력 +80, 기본 공격 시 치유 감소 - 40%, 생명력 흡수 +25%", "[제작] VF 혈액 샘플 + 일본도", "전설")
=======
                te("엑스칼리버", "공격력 +60, 최대체력 +400, 체력재생 +200%", "[제작] 보검 + 성배", "영웅")
                down("보검", "성배", "", "", "")
            }
            if (falselist[i].name1 == "모노호시자오") {
                te("모노호시자오", "공격력 +70, 생명력 흡수 +18%", "[제작] 무라마사 + 정교한 도면", "영웅")
                down("무라마사", "정교한 도면", "", "", "")
            }
            if (falselist[i].name1 == "호푸어드") {
                te("호푸어드", "공격력 +45, 최대체력 +300, 치명타 확률 +20%", "[제작] 보검 + 유리 조각", "영웅")
                down("보검", "유리 조각", "", "", "")
            }
            if (falselist[i].name1 == "레바테인") {
...
<<<<<<< HEAD
                te("빔 엑스", "공격력 +127, 시야 +4", "[제작] \n대부 + 레이저 포인터", "영웅")
                down("대부", "레이저 포인터", "", "", "")
            }
            if (falselist[i].name1 == "산타 무에르테") {
                te("산타 무에르테", "공격력 +100, 최대 체력 +380 ,생명력 흡수 +15%\n기본 공격 사거리 +0.5", "[제작] \n사신의 낫 + 루비", "영웅")
                down("사신의 낫", "루비", "", "", "")
            }
            if (falselist[i].name1 == "스퀴테") {
                te("스퀴테", "공격력 +115, 기본 공격 사거리 +1 \n 스킬 증폭 +20%", "[제작] \n사신의 낫 + 황금", "영웅")
                down("사신의 낫", "황금", "", "", "")
            }
...
=======
                te("빔 엑스", "공격력 +137, 이동속도 -0.1, 시야 +4", "[제작] \n대부 + 레이저 포인터", "영웅")
                down("대부", "레이저 포인터", "", "", "")
            }
            if (falselist[i].name1 == "산타 무에르테") {
            ...
            if (falselist[i].name1 == "파라슈") {
                te("파라슈", "공격력 +115, 이동속도 +0.2, 쿨다운 감소 +10%", "[제작] 경량화 도끼 + 진신사리", "영웅")
                down("경량화 도끼", "진신사리", "", "", "")
            }
            if (falselist[i].name1 == "하르페") {
                te("하르페", "공격력 +125, 이동속도 +0.1, 스킬 증폭 +38, 스킬 공격 사거리+0.5, 스킬 적중 시 치유 감소 -40%", "[제작] 사신의 낫 + 백우선", "영웅")
                down("사신의 낫", "백우선", "", "", "")
            }
            if (falselist[i].name1 == "쌍칼") {
                te("쌍칼", "공격력 +14, 공격속도 +10%", "[제작] \n식칼 + 녹슨 검", "고급")
>>>>>>> origin/master
...
<<<<<<< HEAD
            ...
            if (falselist[i].name1 == "자웅일대검") {
                te("자웅일대검", "공격력 +60, 공격속도 +50%, 기본공격 추가피해 +8", "[제작] \n쌍칼 + 문스톤", "영웅")
                down("쌍칼", "문스톤", "", "", "")
            }
            ...
            if (falselist[i].name1 == "일렉트론 블라스터") {
                te("일렉트론 블라스터", "장탄 수: 10발, 공격력 +61, 이동속도 +0.1\n기본 공격 추가 피해 +25", "[제작]\n 베레타 M92F + 이온 전지", "영웅")
                down("베레타 M92F", "이온 전지", "", "", "")
            }
            if (falselist[i].name1 == "매그넘\u002d보아") {
                te("매그넘\u002d보아", "장탄 수: 7발, 공격력 +95, 이동속도 +0.15\n시야 +2.5, 생명력 흡수 +20%", "[제작]\n 매그넘\u002d아나콘다 + 강철", "영웅")
                down("매그넘-아나콘다", "강철", "", "", "")
            }
            if (falselist[i].name1 == "악켈테") {
                te("악켈테", "장탄 수: 10발, 공격력 +120, 이동속도 +0.2, 시야 +1", "[제작]\n 포스 코어 + 베레타 M92F", "전설")
                down("포스 코어", "베레타 M92F", "", "", "")
            }
            ...
            if (falselist[i].name1 == "Tac\u002d50") {
                te("Tac\u002d50", "장탄 수 : 2발, 공격력 +134, 시야 +2.5, 생명력 흡수 +30%", "[제작]\n 하푼건 + 정교한 도면", "영웅")
                down("하푼건", "정교한 도면", "", "", "")
            }
            ...
            if (falselist[i].name1 == "사사성광") {
                te("사사성광", "장탄 수 : 2발, 공격력 +100, 시야 +2.5, 이동속도 -0.07, 스킬증폭 +33%", "[제작]\n 문스톤 + 금교전", "전설")
                down("문스톤", "금교전", "", "", "")
            }
            ...
            if (falselist[i].name1 == "매화검") {
                te("매화검", "공격력 +121, 치명타 확률 +10%, 치명타 피해량 +25%, 쿨다운 감소 +8%", "[제작] \n레이피어 + 운명의 꽃", "희귀")
                up("듀랜달 Mk2", "볼틱레토", "유성검", "", "")
                down("레이피어", "운명의 꽃", "", "", "")
            }
            if (falselist[i].name1 == "활빈검") {
                te("활빈검", "공격력 +30, 시야 +1, 체력 재생+1.5, 스태미너 재생 +200%, 쿨다운 감소 +12% 치명타 피해량 +25%", "[제작] \n레이피어 + 어사의", "영웅")
                up("미스틸테인", "", "", "", "")
                down("레이피어", "어사의", "", "", "")
            }
            if (falselist[i].name1 == "듀랜달 Mk2") {
                te("듀랜달 Mk2", "공격력 +55, 시야 +2, 생명력 흡수 +8%, 치명타 확률 +10%, 치명타 피해량 +30%, 쿨다운 감소 +8%", "[제작]\n 매화검 + 레이저 포인터", "영웅")
                down("매화검", "레이저 포인터", "", "", "")
            }
            if (falselist[i].name1 == "볼틱레토") {
                te("볼틱레토", "공격력 +47, 공격속도 +35%, 치명타 확률 +10%, 치명타 피해량 +25%, 쿨다운 감소 +8%", "[제작]\n 매화검 + 전자 부품", "영웅")
                down("매화검", "전자 부품", "", "", "")
            }
            if (falselist[i].name1 == "유성검") {
                te("유성검", "공격력 +75, 치명타 피해량 +20%\n치명타 확률 +15%, 쿨다운 감소 +10%", "[제작]\n 매화검 + 운석", "영웅")
                down("매화검", "운석", "", "", "")
            }
            if (falselist[i].name1 == "주와이외즈") {
                te("주와이외즈", "공격력 +71, 치명타 피해량 +30%\n공격 속도 +12%, 이동속도 +0.2", "[제작]\n 레이피어 + 미스릴", "영웅")
                down("레이피어", "미스릴", "", "", "")
            }
            if (falselist[i].name1 == "미스틸테인") {
                te("미스틸테인", "공격력 +33, 시야 +1, 치명타 피해량 +25%, 쿨다운 감소 +12%, 스태미너 재생 +160%, 체력 재생 +1.5, 스킬 증폭 +17%", "[제작]\n 활빈검 + 나뭇가지", "전설")
                down("활빈검", "나뭇가지", "", "", "")
            }
            if (falselist[i].name1 == "볼틱레토") {
            ...
            if (falselist[i].name1 == "화첨창") {
                te("화첨창", "공격력 +115, 체력 재생 +1.5, 스태미너 재생 +1.5, 기본 공격 추가 피해 +30", "[제작]\n 삼매진화 + 죽창", "전설")
                down("삼매진화", "죽창", "", "", "")
            }
            ...
            if (falselist[i].name1 == "안티오크의 수류탄") {
                te("안티오크의 수류탄", "최대 충전 수 : 8발, 공격력 +80, 기본 공격 추가 피해 +85", "[제작]\n고폭 수류탄 + 십자가", "영웅")
                down("고폭 수류탄", "십자가", "", "", "")
            }
            if (falselist[i].name1 == "다비드슬링") {
                te("다비드슬링", "최대 충전 수 : 50발, 공격력 +68, 체력재생 +150%, 기본 공격 추가 피해 +27", "[제작]\n슬링 + 성자의 유산", "영웅")
                down("슬링", "성자의 유산", "", "", "")
            }
            ...
            if (falselist[i].name1 == "루테늄 구슬") {
                te("루테늄 구슬", "최대 충전 수 : 50발, 공격력 +80, 스킬 증폭 +28%, 스킬 적중 시 치유 감소 -40%", "[제작]\n가시 탱탱볼 + 황금", "영웅")
                down("가시 탱탱볼", "황금", "", "", "")
            }
            ...
            if (falselist[i].name1 == "목장갑") {
                te("목장갑", "공격력 +7", "호텔(4개), 병원(3개)의 상자", "일반")
                up("글러브", "건틀릿", "", "", "")
            }
            ...
            if (falselist[i].name1 == "단영촌천투") {
                te("단영촌천투", "공격력 +50, 방어력 +21, 스태미너 재생 +50%, 생명력 흡수 +10%", "[제작]\n귀골 장갑 + 인형", "영웅")
                up("", "", "", "", "")
                down("귀골 장갑", "인형", "", "", "")
            }

            if (falselist[i].name1 == "디바인 피스트") {
                te("디바인 피스트", "공격력 +53, 이동속도 -0.07, 기본 공격 추가 피해 +33", "[제작]\n벽력귀투 + 십자가", "영웅")
                up("", "", "", "", "")
                down("벽력귀투", "십자가", "", "", "")
            }
            ...
            if (falselist[i].name1 == "여래수투") {
                te("여래수투", "공격력 +37 쿨다운 감소 +18% 스킬 증폭 +18%", "[제작]\n회단 장갑 + 진신사리", "영웅")
                up("", "", "", "", "")
                down("회단 장갑", "진신사리", "", "", "")
            }
...
=======
                te("이천일류", "공격력 +41, 공격속도 +10%, 생명력 흡수 +18%, 스킬 적중 시 치유 감소 -40%", "[제작] \n피렌체식 쌍검 + 못", "영웅")
                down("피렌체식 쌍검", "못", "", "", "")
            }
            if (falselist[i].name1 == "자웅일대검") {
                te("자웅일대검", "공격력 +55, 공격속도 +50%", "[제작] \n쌍칼 + 문스톤", "영웅")
                down("쌍칼","문스톤","","","")
            }
            if (falselist[i].name1 == "디오스쿠로이") {
                te("디오스쿠로이", "공격력 +40, 공격속도 +50%", "[제작] \n쌍칼 + 이온 전지", "영웅")
                down("쌍칼","이온 전지","","","")
            }
            if (falselist[i].name1 == "로이거 차르"){
                te( "로이거 차르", "공격력 +33, 공격속도 +20%, 스킬 증폭 +36", "[제작] \n쌍칼 + 독약", "영웅")
                down("쌍칼","독약","","","")
            }
            if (falselist[i].name1 == "발터 PPK\u002dMagnum"){
                te("발터 PPK", "장탄 수: 6발, 공격력 +8, 이동속도 +0.1", "사용 시 기본 지급\n" + "모래사장(4개), 호텔(5개), 공장(4개)의 상자", "일반")
                up("매그넘-파이썬","베레타 M92F","","","")
            }
            if (falselist[i].name1 == "매그넘\u002d파이썬"){
                te("매그넘\u002d파이썬", "장탄 수: 6발, 공격력 +15, 공격속도 +10%\n, 이동속도 +0.1", "[제작]\n 발터 PPK Magnum + 오일", "고급")
            ...
            if (falselist[i].name1 == "마탄의 사수"){
                te("마탄의 사수", "장탄 수: 7발, 공격력 +30, 이동속도 +0.1\n스킬 증폭 +40, 공격 속도 +10%", "[제작]\n 더블 리볼버 SP + 재", "영웅")
                down("더블 리볼버 SP", "재","","","")
            }
            if (falselist[i].name1 == "엘레강스"){
                te("엘레강스", "장탄 수: 6발, 공격력 +90, 이동속도 +0.2, 시야 +5", "[제작]\n FN57 + 먼지털이개", "영웅")
            ...
            if (falselist[i].name1 == "화승총"){
                te("화승총", "장탄 수 : 1발, 공격력 +34, 이동속도 -0.1", "사용 시 기본 지급, 항구(3개), 숲(4개)의 상자", "일반")
                up("스프링필드","","","","")
            }
            if (falselist[i].name1 == "스프링필드"){
                te("스프링필드", "장탄 수 : 1발, 공격력 +50, 이동속도 -0.1, 시야 +1.5", "[제작] 화승총 + 레이저 포인터\n초록색 항공 보급", "고급")
                up("하푼건","금교전","레일건","","")
                down("화승총","레이저 포인터","","","")
            }
            if (falselist[i].name1 == "하푼건"){
                te("하푼건", "장탄 수 : 2발, 공격력 +64, 이동속도 -0.1, 시야 +2", "[제작]\n 스프링필드 + 단창", "희귀")
                up("Tac-50","인터벤션","","","")
                down("스프링필드","단창","","","")
            }
            if (falselist[i].name1 == "금교전"){
                te("금교전", "장탄 수 : 1발, 공격력 +56, 이동속도 -0.15, 시야 +2.5, 스킬증폭 +18%", "[제작]\n 스프링필드 + 황금", "희귀")
                up("NTW-20","사사성광","","","")
                down("스프링필드","황금","","","")
            }
            if (falselist[i].name1 == "레일건"){
                te("레일건", "장탄 수 : 3발, 공격력 +78, 이동속도 -0.15, 시야 +2, 공격속도 +20%", "[제작]\n 스프링필드 + 전자 부품", "희귀")
                up("폴라리스","","","","")
                down("스프링필드","전자 부품","","","")
            }
            if (falselist[i].name1 == "Tac\u002d50"){
                te("Tac\u002d50", "장탄 수 : 2발, 공격력 +140, 이동속도 -0.03, 시야 +2.5, 생명력 흡수 +20%", "[제작]\n 하푼건 + 정교한 도면", "영웅")
                down("하푼건","정교한 도면","","","")
            }
            if (falselist[i].name1 == "인터벤션"){
                te("인터벤션", "장탄 수 : 2발, 공격력 +110, 시야 +4.5, 기본 공격 사거리 +1", "[제작]\n 하푼건 + 망원 카메라", "영웅")
                down("하푼건","망원 카메라","","","")
            }
            if (falselist[i].name1 == "NTW\u002d20"){
                te("NTW\u002d20", "장탄 수 : 1발, 공격력 +95, 시야 +2.5, 이동속도 -0.1, 스킬증폭 +22%", "[제작]\n 금교전 + 철판", "영웅")
                down("금교전","철판","","","")
            }
            if (falselist[i].name1 == "폴라리스"){
                te("폴라리스", "장탄 수 : 3발, 공격력 +135, 시야 +2, 공격속도 +40%", "[제작]\n 레일건 + 백색 가루", "영웅")
                down("레일건","백색 가루","","","")
            }

            if (falselist[i].name1 == "사사성광"){
                te("사사성광", "장탄 수 : 1발, 공격력 +95, 시야 +2.5, 이동속도 -0.1, 스킬증폭 +30%", "[제작]\n 문스톤 + 금교전", "전설")
                down("문스톤","금교전","","","")
            }
            if (falselist[i].name1 == "바늘"){
                te("바늘", "공격력 +3, 치명타 피해량 +25%", "사용 시 기본 지급\n" +
                        "골목길(7개), 호텔(6개), 병원(6개)의 상자", "일반")
                up("레이피어","분대장 완장","한방침","다트","독침")
            }
            if (falselist[i].name1 == "레이피어"){
                te("레이피어", "공격력 +16, 치명타 피해량 +25%", "[제작] \n바늘 + 철광성", "고급")
            ...
            if (falselist[i].name1 == "듀랜달 Mk2"){
                te("듀랜달 Mk2", "공격력 +51, 시야 +3, 치명타 확률 +10%, 치명타 피해량 +25%, 쿨다운 감소 +10%", "[제작]\n 매화검 + 레이저 포인터", "영웅")
                down("매화검","레이저 포인터","","","")
            }
            if (falselist[i].name1 == "볼틱레토"){
                te("볼틱레토", "공격력 +47, 공격속도 +35%, 치명타 확률 +10%, 치명타 피해량 +25%, 쿨다운 감소 +10%", "[제작]\n 매화검 + 전자 부품", "영웅")
            ...
            if (falselist[i].name1 == "트리아이나"){
                te("트리아이나", "공격력 +120, 이동속도 -0.05", "[제작]\n 바이던트 + 파이크", "영웅")
                down("바이던트","파이크","","","")
            }
            if (falselist[i].name1 == "방천화극"){
                te("방천화극", "공격력 +88, 이동속도 -0.1, 스킬 적중 시 치유 감소 -40%, 스킬 증폭 +37%", "[제작]\n 도끼창 + 군선", "영웅")
                down("도끼창","군선","","","")
            }
            if (falselist[i].name1 == "청룡언월도"){
                te("청룡언월도", "공격력 +130, 이동속도 -0.1", "[제작]\n 도끼창 + 철판", "영웅")
                down("도끼창","철판","","","")
            }
            if (falselist[i].name1 == "화첨창"){
            ...
            if (falselist[i].name1 == "망치"){
                te("망치", "공격력 +16", "사용 시 기본 지급, 연못(7개), 모래사장(6개), 골목길(8개)의 상자, 맷돼지(사냥)", "일반")
                up("워해머","루비","철판","","")
            }
            if (falselist[i].name1 == "워해머"){
                te("워해머", "공격력 +40", "[제작]\n망치 + 단봉", "고급")
            ...
            if (falselist[i].name1 == "다그다의 망치"){
                te("다그다의 망치", "공격력 +95, 체력 재생 +250%", "[제작]\n사슴 망치 + 성자의 유산", "영웅")
                down("사슴 망치","성자의 유산","","","")
            }
            if (falselist[i].name1 == "토르의 망치"){
                te("토르의 망치", "공격력 +120, 공격속도 +40%", "[제작]\n사슴 망치 + 이온 전지", "영웅")
            ...
            if (falselist[i].name1 == "마법봉"){
                te("마법봉", "공격력 +65, 생명력 흡수 +30%, 스킬 증폭 +27%", "[제작]\n 워해머 + 달빛 펜던트", "영웅")
                down("워해머","달빛 펜던트","","","")
            }
            if (falselist[i].name1 == "쇠구슬"){
                te("쇠구슬", "장탄 수: 50, 공격력 +12", "양궁장(5개), 숲(7개), 공장(7개)의 상자\n" +
            ...
            if (falselist[i].name1 == "가시 탱탱볼"){
                te("가시 탱탱볼", "공격력 +36, 스킬 적중 시 치유 감소 -40%", "[제작]\n플러버 + 못", "희귀")
                up("루테늄 구슬","","","","")
                down("플러버","못","","","")
            }
            if (falselist[i].name1 == "소이탄"){
                te("소이탄", "최대 충전 수 : 50발, 공격력 +70, 공격속도 +50%", "[제작]\n화염병 + 볼 라이트닝", "영웅")
                down("화염병","볼 라이트닝","","","")
            }
            if (falselist[i].name1 == "안티오크의 수류탄"){
                te("안티오크의 수류탄", "최대 충전 수 : 8발, 공격력 +85, 기본 공격 추가 피해 +80", "[제작]\n고폭 수류탄 + 십자가", "영웅")
                down("고폭 수류탄","십자가","","","")
            }
            if (falselist[i].name1 == "다비드슬링"){
                te("다비드슬링", "최대 충전 수 : 50발, 공격력 +80, 체력재생 +150%, 기본 공격 추가 피해 +30", "[제작]\n슬링 + 성자의 유산", "영웅")
                down("슬링","성자의 유산","","","")
            }
            if (falselist[i].name1 == "연막탄"){
            ...
            if (falselist[i].name1 == "루테늄 구슬"){
                te("루테늄 구슬", "최대 충전 수 : 50발, 공격력 +80, 스킬 증폭 +20%, 스킬 적중 시 치유 감소 -40%", "[제작]\n가시 탱탱볼 + 황금", "영웅")
                down("가시 탱탱볼","황금","","","")
            }
            ...
            if(falselist[i].name1 == "귀골 장갑"){
                te("귀골 장갑","공격력 +35, 방어력 +13, 이동속도 -0.1","[제작]\n건틀릿 + 거북이 등딱지","희귀")
                up("단영촌천투","브레이질 건틀릿","","","")
                down("건틀릿","거북이 등딱지","","","")
            }
            ...
            if(falselist[i].name1 == "디바인 피스트"){
                te("디바인 피스트","공격력 +42, 이동속도 -0.05, 기본 공격 추가 피해 +33","[제작]\n벽력귀투 + 십자가","영웅")
                up("","","","","")
                down("벽력귀투","십자가","","","")
            }
            ...
            if(falselist[i].name1 == "빙화현옥수"){
                te("빙화현옥수","공격력 +27, 쿨다운 감소 +15%, 스킬 증폭 +38","[제작]\n회단 장갑 + 얼음","영웅")
                up("","","","","")
                down("회단 장갑","얼음","","","")
            }
            if(falselist[i].name1 == "여래수투"){
                te("여래수투","공격력 +33 쿨다운 감소 +10% 스킬 증폭 +18%","[제작]\n회단 장갑 + 진신사리","영웅")
                up("","","","","")
                down("회단 장갑","진신사리","","","")
            }

            if(falselist[i].name1 == "브레이질 건틀릿"){
                te("브레이질 건틀릿","공격력 +48, 방어력 +13, 체력 재생 +1, 공격 속도 +30%, 이동속도 -.0.05","[제작]\n귀골 장갑 + 기름먹인 천 ","영웅")
                up("","","","","")
                down("귀골 장갑","기름먹인 천","","","")
            }
            ...
            if (falselist[i].name1 == "대나무"){
                te("대나무", "공격력 +12", "사용 시 기본 지급\n" + "연못(7개), 절(7개), 양궁장(6개),묘지(7),숲(7)의 상자, 박쥐(사냥)", "일반")
>>>>>>> origin/master
...
=======
            ...
            if(falselist[i].name1 == "택티컬 톤파"){
                te("택티컬 톤파", "공격력 +70, 방어력 +10, 생명력 흡수 +25%", "[제작]\n 경찰봉 + 정교한 도면", "영웅")
                down("경찰봉 + 정교한 도면","","","","")
            }
            if(falselist[i].name1 == "마이쏙"){
                te("마이쏙","공격력 +45, 방어력 +20, 체력 재생 +100%","[제작]\n 류큐톤파 + 단봉", "영웅")
                down("류큐톤파", "단봉","","","")
            }
            if(falselist[i].name1 == "플라즈마 톤파"){
...
<<<<<<< HEAD
            ...
            if (falselist[i].name1 == "구원의 여신상") {
                te("구원의 여신상", "공격력 +78, 체력 재생 +0.6, 스태미너 재생 +60%, 공격 속도 +15%, 생명력 흡수 +12%", "[제작]\n횃불 + 인형", "영웅")
                up("", "", "", "", "")
                down("횃불", "인형", "", "", "")
            }
            ...
            if (falselist[i].name1 == "스파이의 우산") {
                te("스파이의 우산", "공격력 +65, 스킬 증폭 +28, 스태미너 재생 +0.8", "[제작]\n우산 + 재", "영웅")
                up("", "", "", "", "")
                down("우산", "재", "", "", "")
            }
            ...
            if (falselist[i].name1 == "편전") {
                te("편전", "공격력 +58, 기본 공격 추가 피해 +40", "[제작]\n국궁 + 대나무", "영웅")
                up("", "", "", "", "")
                down("국궁", "대나무", "", "", "")
            }
            ...
            if (falselist[i].name1 == "면도칼") {
                te("면도칼", "장탄 수: 50, 공격력 +11", "사용 시 기본 지급 , 병원, 성당, 학교의 상자 ,박쥐(사냥)", "일반")
                up("표창", "흑건", "치파오", "블리더", "철편")
                down("", "", "", "", "")
            }
            ...
            if (falselist[i].name1 == "옥전결") {
                te("옥전결", "장탄 수: 12, 공격력 +60, 스킬 증폭 +10%", "[제작]\n부적 + 재", "영웅")
                up("", "", "", "", "")
                down("부적", "재", "", "", "")
            }
            if (falselist[i].name1 == "풍마 수리검") {
                te("풍마 수리검", "장탄 수: 50, 공격력 +55, 쿨다운 감소 +15%, 기본 공격 추가 피해 +36", "[제작]\n매화비표 + 알코올", "영웅")
                up("", "", "", "", "")
                down("매화비표", "알코올", "", "", "")
            }
            ...
            if (falselist[i].name1 == "푸른색 단도") {
                te("푸른색 단도", "장탄 수: 50, 공격력 +20, 기본 공격 추가 피해 +29, 스킬 증폭 +21", "[제작]\n흑건 + 독약", "영웅")
                up("", "", "", "", "")
                down("흑건", "독약", "", "", "")
            }
            if (falselist[i].name1 == "플레셋") {
                te("플레셋", "장탄 수: 20, 공격력 +85, 이동속도 +0.25, 치명타 피해량 +15%, 기본 공격 사거리 +0.5", "[제작]\n플럼바타 + 백색 가루", "")
                up("", "", "", "", "")
                down("플럼바타", "백색 가루", "", "", "")
            }
            ...
            if (falselist[i].name1 == "천국의 계단") {
                te("천국의 계단", "공격력 +66, 쿨다운 감소 +8%, 체력 재생 +200%, 시야 +3, 스킬 증폭 +20%", "[제작] 험버커 픽업 + 성배\n보라색 항공 보급 ", "영웅")
                up("", "", "", "", "")
                down("", "", "", "", "")
            }
            ...
            if (falselist[i].name1 == "새티스팩션") {
                te("새티스팩션", "공격력 +30, 공격속도 +30%, 생명력 흡수 +15%, 기본 공격 추가 피해 +11", "[제작]\n노캐스터 + 돌멩이", "영웅")
                up("", "", "", "", "")
                down("노캐스터", "돌멩이", "", "", "")
            }
            ...
            if (falselist[i].name1 == "틴 스피릿") {
                te("틴 스피릿", "공격력 +10, 기본 공격 사거리 +1, 공격속도 +30%, 기본 공격 추가 피해 +25", "[제작]\n야생마 + 진신사리", "영웅")
                up("", "", "", "", "")
                down("야생마", "진신사리", "", "", "")
            }
...
=======
            ...
            if(falselist[i].name1 == "타구봉"){
                te("타구봉","공격력 +80, 공격속도 +50%, 기본 공격 시 치유 감소 -40%","[제작]\n도깨비 방망이 + 모터","영웅")
                up("","","","","")
                down("도깨비 방망이","모터","","","")
            }
            if(falselist[i].name1 == "스파이의 우산"){
                te("스파이의 우산","공격력 +60, 스킬 증폭 +20","[제작]\n우산 + 독약","영웅")
                up("","","","","")
                down("우산","독약","","","")
            }
            if(falselist[i].name1 == "여의봉"){
            ...
            if(falselist[i].name1 == "컴포지트 보우"){
                te("컴포지트 보우","공격력 +16, 기본 공격 시 치유 감소 -40%","[제작]\n장궁 + 못","희귀")
                up("트윈보우","","","","")
                down("장궁","못","","","")
            }
            ...
            if(falselist[i].name1 == "벽력궁"){
                te("벽력궁","공격력 +20, 기본 공격 추가 피해 +11","[제작]\n장궁 + 화약","희귀")
                up("국궁","","","","")
                down("장궁","화약","","","")
            }
            if(falselist[i].name1 == "탄궁"){
            ...
            if(falselist[i].name1 == "골든래쇼 보우"){
                te("골든래쇼 보우","공격력 +68, 스킬 증폭 +20%","[제작]\n탄궁 + 황금","영웅")
                up("","","","","")
                down("탄궁","황금","","","")
            }

            if(falselist[i].name1 == "트윈보우"){
                te("트윈보우","공격력 +70, 공격속도 +50%, 기본 공격 시 치유 감소 -40%","[제작]\n강궁 + 컴포지트 보우","영웅")
                up("","","","","")
                down("강궁","컴포지트 보우","","","")
            }
            if(falselist[i].name1 == "엘리멘탈 보우"){
                te("엘리멘탈 보우","공격력 +60, 이동속도 +0.1, 스킬 증폭 +41, 스킬 적중 시 치유 감소 -40%","[제작]\n화전 + 백우선","영웅")
                up("","","","","")
                down("화전","백우선","","","")
            }

            if(falselist[i].name1 == "페일노트"){
                te("페일노트","공격력 +90, 공격속도 +15%, 생명력 흡수 +15%","[제작]\nVF 혈액 샘플 + 강궁","전설")
                up("","","","","")
                down("VF 혈액 샘플","강궁","","","")
            }
            ...
            if(falselist[i].name1 == "헤비 크로스보우"){
                te("헤비 크로스보우","공격력 +72, 이동 속도 -0.1","[제작]\n쇠뇌 + 강철","희귀")
                up("발리스타","","","","")
                down("쇠뇌","강철","","","")
            }
            if(falselist[i].name1 == "철궁"){
            ...
            if(falselist[i].name1 == "매화비표"){
                te("매화비표","장탄 수: 50, 공격력 +14, 쿨다운 감소 +10%, 기본 공격 추가 피해 +30","[제작]\n유엽비도 + 꽃","희귀")
                up("풍마수리검","","","","")
                down("유엽비도","꽃","","","")
            }
            if(falselist[i].name1 == "독침"){
            ...
            if(falselist[i].name1 == "법륜"){
                te("법륜","장탄 수: 50, 공격력 +34, 스킬 증폭 +15%","[제작]\n챠크람 + 불경","희귀")
                up("건곤권","","","","")
                down("챠크람","불경","","","")
            }
            if(falselist[i].name1 == "플럼바타"){
            ...
            if(falselist[i].name1 == "미치광이왕의 카드"){
                te("미치광이왕의 카드","장탄 수: 52, 공격력 +49, 공격속도 +30%, 치명타 확률 +20%","[제작]\n빈티지 카드 + 이온 전지","영웅")
                up("","","","","")
                down("빈티지 카드","이온 전지","","","")
            }
            if(falselist[i].name1 == "옥전결"){
            ...
            if(falselist[i].name1 == "풍마 수리검"){
                te("풍마 수리검","장탄 수: 50, 공격력 +44, 쿨다운 감소 +15%, 기본 공격 추가 피해 +36","[제작]\n매화비표 + 알코올","영웅")
                up("","","","","")
                down("매화비표","알코올","","","")
            }
            if(falselist[i].name1 == "빙백은침"){
            ...
            if(falselist[i].name1 == "플레셋"){
                te("플레셋","장탄 수: 20, 공격력 +85, 이동속도 +0.2, 치명타 피해량 +40%","[제작]\n플럼바타 + 백색 가루","")
                up("","","","","")
                down("플럼바타","백색 가루","","","")
            }
            if(falselist[i].name1 == "건곤권"){
            ...
            if(falselist[i].name1 == "보급형 기타"){
                te("보급형 기타","공격력 +5","기타 사용 시 기본 지급","일반")
                up("골든 브릿지","싱글 픽업","","","")
                down("","","","","")
            }
            if(falselist[i].name1 == "골든 브릿지"){
            ...
            if(falselist[i].name1 == "천국의 계단"){
                te("천국의 계단","공격력 +52, 체력 재생 +200%, 시야 +4, 스킬 증폭 +20%","[제작] 험버커 픽업 + 성배\n보라색 항공 보급 ","영웅")
                up("","","","","")
                down("","","","","")
            }
            if(falselist[i].name1 == "퍼플 헤이즈"){
                te("퍼플 헤이즈","공격력 +85, 스킬 증폭 +19%","[제작]\nKing-V + 재","영웅")
                up("","","","","")
                down("King-V","재","","","")
            }
            if(falselist[i].name1 == "새티스팩션"){
            ...
            if(falselist[i].name1 == "원더풀 투나잇"){
                te("원더풀 투나잇","공격력 +100, 공격속도 +45%, 기본 공격 추가 피해 +2","[제작]\n슈퍼스트랫 + 운석","영웅")
                up("","","","","")
                down("슈퍼스트랫","운석","","","")
            }
            if(falselist[i].name1 == "더 월"){
                te("더 월","공격력 +70, 공격속도 +18%, 기본 공격 추가 피해 +2","[제작]\n슈퍼스트랫 + 백색 가루","영웅")
                up("","","","","")
                down("슈퍼스트랫","백색 가루","","","")
            }
            if(falselist[i].name1 == "틴 스피릿"){
                te("틴 스피릿","공격력 +10, 공격속도 +25%, 기본 공격 추가 피해 +2-","[제작]\n야생마 + 진신사리","영웅")
                up("","","","","")
                down("야생마","진신사리","","","")
            }
            if (falselist[i].name1 == "쇠사슬"){
...
=======
            ...
            if(falselist[i].name1 == "샤퍼"){
                te("샤퍼","공격력 +19, 스킬 적중 시 치유 감소 -40%","[제작]\n눈차크 + 못","희귀")
                up("대소롱뱐곤","","","","")
                down("눈차크","못","","","")
            }
            if(falselist[i].name1 == "블리더"){
            ...
            if(falselist[i].name1 == "대소반룡곤"){
                te("대소반룡곤","공격력 +50, 스킬증폭 +14, 스킬 적중 시 치유 감소 -40%","[제작]\n샤퍼 + 재","영웅")
                up("","","","","")
                down("샤퍼","재","","","")
            }
            if(falselist[i].name1 == "초진동눈차크"){
...
<<<<<<< HEAD
            ...
            if (falselist[i].name1 == "수정 티아라") {
                te("수정 티아라", "방어력 +21, 최대 스태미너 +600, 치명타 확률 +20%", "[제작]티아라 + 유리 조각\n", "영웅")
                up("", "", "", "", "")
                down("티아라", "유리 조각", "", "", "")
            }
            ...
            if (falselist[i].name1 == "황실 부르고넷") {
                te("황실 부르고넷", "방어력 +8, 최대 스태미너 +200, 이동속도 +0.08, 쿨다운 감소 +8%, 스킬 증폭 +14%", "[제작] 투구 + 황금\n보라색 항공 보급", "영웅")
                up("", "", "", "", "")
                down("투구", "황금", "", "", "")
            }
            if (falselist[i].name1 == "변검") {
                te("변검", "방어력 +16, 최대 스태미너 +300, 이동속도 +0.2, 생명력 흡수 +22%, 비전투중 이동속도 +0.3", "[제작] 가면 + VF 혈액 샘플\n보라색 항공 보급", "영웅")
                up("", "", "", "", "")
                down("가면", "VF 혈액 샘플", "", "", "")
            }
            ...
            if (falselist[i].name1 == "석양의 갑옷") {
                te("석양의 갑옷", "방어력 +22, 최대 체력 +360", "[제작] 가죽 갑옷 + 루비\n파란색 항공 보급", "희귀")
                up("", "", "", "", "")
                down("", "", "", "", "")
            }
            ...
            if (falselist[i].name1 == "광학미채 슈트") {
                te("광학미채 슈트", "공격력 +10, 방어력 +15, 치명타 확률 +22%, 스킬 피해 감소 +10%", "[제작] 잠수복 + 유리판\n보라색 항공 보급", "영웅")
                up("", "", "", "", "")
                down("잠수복", "유리판", "", "", "")
            }
            if (falselist[i].name1 == "락커의 자켓") {
                te("락커의 자켓", "공격력 +30, 방어력 +18, 비전투중 이동속도 +0.1, 기본 공격 피해 감소 +15, 스킬 적중 시 치유 감소 -40%", "[제작] 라이더 자켓 + 소란 발생기\n보라색 항공 보급", "영웅")
                up("", "", "", "", "")
                down("라이더 자켓", "소란 발생기", "", "", "")
            }
            if (falselist[i].name1 == "미스릴 갑옷") {
                te("미스릴 갑옷", "방어력 +65, 공격속도 +12%, 이동속도 +0.2, 스킬 피해 고정 감소 +10", "[제작] 미스릴 + 가죽 갑옷\n보라색 항공 보급", "미스릴 갑옷")
                up("", "", "", "", "")
                down("미스릴", "가죽 갑옷", "", "", "")
            }
            ...
            if (falselist[i].name1 == "배틀 슈트") {
                te("배틀 슈트", "방어력 +25, 최대 체력 +170, 기본 공격 피해 감소 +12, 스킬 피해 감소 +12%", "[제작] 방탄조끼 + 잠수복\n보라색 항공 보급", "영웅")
                up("", "", "", "", "")
                down("방탄조끼", "잠수복", "", "", "")
            }
            if (falselist[i].name1 == "EOD 슈트") {
                te("EOD 슈트", "방어력 +25, 최대 체력 +270, 체력 재생 +1, 쿨다운 감소 +10%, 기본 공격 피해 감소 +8", "[제작] 방탄조끼 + 덧댄 로브\n보라색 항공 보급", "영웅")
                up("", "", "", "", "")
                down("방탄조끼", "덧댄 로브", "", "", "")
            }
            if (falselist[i].name1 == "불꽃 드레스") {
                te("불꽃 드레스", "방어력 +30, 공격력 +10, 체력 재생 +2.5, 스태미너 재생 +3, 스태미너 재생 +75%, 기본 공격 추가 피해 +18", "[제작] 삼매진화 + 드레스\n노란색 항공 보급", "전설")
                up("", "", "", "", "")
                down("", "", "", "", "")
            }
            ...
            if (falselist[i].name1 == "고장난 시계") {
                te("고장난 시계", "쿨다운 감소 + 5%", "[제작] 손목시계 + 접착제", "고급")
                up("틴달로스의 팔찌", "", "", "", "")
                down("손목시계", "접착제", "", "", "")
            }
            if (falselist[i].name1 == "틴달로스의 팔찌") {
            ...
            if (falselist[i].name1 == "소드 스토퍼") {
                te("소드 스토퍼", "방어력 +30, 기본 공격 피해 감소 +8, 치명타 피해 감소 +8%, 기본 공격 시 치유 감소 -40%", "[제작] 바주반드 + 못\n보라색 항공 보급", "영웅")
                up("", "", "", "", "")
                down("바주반드", "못", "", "", "")
            }
            ...
            if (falselist[i].name1 == "캐리비안 장식총") {
                te("캐리비안 장식총", "공격력 +10, 생명력 흡수 +8%", "[제작] 발터 PPK + 리본\n 초록색 항공 보급", "고급")
                up("해적의 증표", "", "", "", "")
                down("발터 PPK", "리본", "", "", "")
            }
            if (falselist[i].name1 == "해적의 증표") {
                te("해적의 증표", "공격력 +15, 생명력 흡수 +8%, 치명타 확률 +12%", "[제작] 캐리비안 장식총 + 식칼\n파라색 항공 보급", "희귀")
                up("", "", "", "", "")
                down("캐리비안 장식총", "식칼", "", "", "")
            }
            if (falselist[i].name1 == "아이기스") {
                te("아이기스", "체력 +320, 스태미너 +250, 공격력 +10, 방어력 +10", "[제작] 진홍 팔찌 + 가죽 방패\n보라색 항공 보급", "영웅")
                up("", "", "", "", "")
                down("진홍 팔찌", "가죽 방패", "", "", "")
            }
            if (falselist[i].name1 == "스카디의 팔찌") {
                te("스카디의 팔찌", "최대 체력 +200, 최대 스태미너 +250, 체력 재생 +1.5, 스태미너 재생 +1.5, 스킬 증폭 +20", "[제작] 만년빙 + 진홍 팔찌\n노란색 항공 보급", "전설")
                up("", "", "", "", "")
                down("만년빙", "진홍 팔찌", "", "", "")
            }
            ...
            if (falselist[i].name1 == "힐리스") {
                te("힐리스", "이동속도 +0.12, 비전투중 이동 속도 +0.5", "[제작] 운동화 + 쇠구슬\n초록색 항공 보급", "고급")
                up("매버릭 러너", "헤르메스의 부츠", "", "", "")
                down("운동화", "쇠구슬", "", "", "")
            }
            ...
            if (falselist[i].name1 == "매버릭 러너") {
                te("매버릭 러너", "공격속도 +15%, 이동속도 +0.2, 비전투중 이동속도 +0.45", "[제작] 힐리스 + 전자 부품\n파란색 항공 보급", "희귀")
                up("", "", "", "", "")
                down("힐리스", "전자 부품", "", "", "")
            }
            ...
            if (falselist[i].name1 == "미스릴 부츠") {
                te("미스릴 부츠", "방어력 +26, 공격속도 +12%, 이동속도 +0.45", "[제작] 미스릴 + 체인 레깅스\n보라색 항공 보급", "영웅")
                up("", "", "", "", "")
                down("미스릴", "체인 레깅스", "", "", "")
            }
            if (falselist[i].name1 == "부케팔로스") {
                te("부케 팔로스", "공격력 +5, 방어력 +10, 스태미너 재생 +1, 이동속도 +0.33, 치명타 확률 +15%", "[제작]킬힐 + 체인 레깅스\n보라색 항공 보급", "영웅")
                up("", "", "", "", "")
                down("킬힐", "체인 레깅스", "", "", "")
            }
            ...
            if (falselist[i].name1 == "글레이셜 슈즈") {
                te("글레이셜 슈즈", "체력 재생 +1.5, 스태미너 재생 +1.5, 스태미너 재생 +60%, 이동속도 +0.25, 비전투중 이동속도 +0.4, 스킬증폭 +15", "[제작] 덧댄 슬리퍼 + 만년빙\n노란색 항공 보급", "전설")
                up("", "", "", "", "")
                down("만년빙", "덧댄 슬리퍼", "", "", "")
            }
...
=======
            ...
            if(falselist[i].name1 == "수정 티아라"){
                te("수정 티아라","방어력 +14, 최대 스태미너 +700, 치명타 확률 +22%","[제작]티아라 + 유리 조각\n","영웅")
                up("","","","","")
                down("티아라","유리 조각","","","")
            }
            if(falselist[i].name1 == "전술-OPS 헬멧"){
                te("전술-OPS 헬멧","방어력 +15, 최대 체력 +120, 공격속도 +20%, 쿨다운 감소 +15%","[제작] 방탄모 + 전자 부품\n보라색 항공 보급","영웅")
                up("","","","","")
                down("방탄모","전자 부품","","","")
            }
            if(falselist[i].name1 == "기사단장의 투구"){
                te("기사단장의 투구","방어력 +20, 최대 스태미너 +200, 이동속도 +0.1, 쿨다운 감소 +10%, 스킬 피해 감소 +11%","[제작] 투구 + 고무\n보라색 항공 보급","영웅")
                up("","","","","")
                down("투구","고무","","","")
            }
            if(falselist[i].name1 == "제국 왕관"){
            ...
            if(falselist[i].name1 == "석양의 갑옷"){
                te("석양의 갑옷","방어력 +28, 최대 체력 +450","[제작] 가죽 갑옷 + 루비\n파란색 항공 보급","희귀")
                up("","","","","")
                down("","","","","")
            }
            if(falselist[i].name1 == "어사의"){
            ...
            if(falselist[i].name1 == "락커의 자켓"){
                te("락커의 자켓","공격력 +30, 방어력 +11, 비전투중 이동속도 +0.2, 기본 공격 피해 감소 +15, 스킬 적중 시 치유 감소 -40%","[제작] 라이더 자켓 + 소란 발생기\n보라색 항공 보급","영웅")
                up("","","","","")
                down("라이더 자켓","소란 발생기","","","")
            }
            if(falselist[i].name1 == "미스릴 갑옷"){
            ...
            if(falselist[i].name1 == "성기사의 갑옷"){
                te("성기사의 갑옷","방어력 +30, 체력 재생 +200%, 이동속도 -0.02, 기본 공격 추가 피해 +15","[제작] 판금 갑옷 + 성자의 유산\n보라색 항공 보급","영웅")
                up("","","","","")
                down("판금 갑옷","성자의 유산","","","")
            }
            if(falselist[i].name1 == "아마조네스 아머"){
            ...
            if(falselist[i].name1 == "지휘관의 갑옷"){
                te("지휘관의 갑옷","방어력 +20, 스킬 증폭 +16%","[제작] 사슬 갑옷 + 황금\n보라색 항공 보급","영웅")
                up("","","","","")
                down("사슬 갑옷","황금","","","")
            }
            if(falselist[i].name1 == "집사복"){
            ...
            if(falselist[i].name1 == "EOD 슈트"){
                te("EOD 슈트","방어력 +15, 최대 체력 +300, 체력 재생 +1, 쿨다운 감소 +10%, 기본 공격 피해 감소 +10","[제작] 방탄조끼 + 덧댄 로브\n보라색 항공 보급","영웅")
                up("","","","","")
                down("방탄조끼","덧댄 로브","","","")
            }
            if(falselist[i].name1 == "불꽃 드레스"){
                te("불꽃 드레스","방어력 +25, 체력 재생 +2.5, 스태미너 재생 +3, 스태미너 재생 +75%, 기본 공격 추가 피해 +18","[제작] 삼매진화 + 드레스\n노란색 항공 보급","전설")
                up("","","","","")
                down("","","","","")
            }
            if(falselist[i].name1 == "카바나"){
                te("카바나","방어력 +38, 스킬 증폭 +18%","[제작] 운석 + 지휘관의 갑옷\n노란색 항공 보급","전설")
                up("","","","","")
                down("운석","지휘관의 갑옷","","","")
            }
            if(falselist[i].name1 == "퀸 오브 하트"){
                te("퀸 오브 하트","방어력 +45, 체력 재생 +3, 쿨다운 감소 +25%","[제작] VF 혈액 샘플 + 한복\n노란색 항공 보급","전설")
                up("","","","","")
                down("VF 혈액 샘플","한복","","","")
            }
            if(falselist[i].name1 == "손목시계"){
            ...
            if(falselist[i].name1 == "진홍 팔찌"){
                te("진홍 팔찌","최대 체력 +200, 최대 스태미너 +250","[제작] 팔찌 + 루비\n파란색 항공 보급","희귀")
                up("스카디의 팔찌","","","","")
                down("팔찌","루비","","","")
            }
            if(falselist[i].name1 == "강철 방패"){
                te("강철 방패","공격력 +23, 방어력 +25, 이동속도 -0.1","[제작] 방패 + 강철\n파란색 항공 보급","희귀")
                up("기사의 신조","","","","")
                down("방패","강철","","","")
            }
            if(falselist[i].name1 == "큐브 워치"){
            ...
            if(falselist[i].name1 == "소드 스토퍼"){
                te("소드 스토퍼","방어력 +26, 기본 공격 피해 감소 +11, 기본 공격 시 치유 감소 -40%","[제작] 바주반드 + 못\n보라색 항공 보급","영웅")
                up("","","","","")
                down("바주반드","못","","","")
            }
            if(falselist[i].name1 == "드라우프니르"){
                te("드라우프니르","방어력 +10, 최대 스태미너 +240, 체력 재생 +1, 스킬 증폭 15%","[제작] 금팔찌 + 브레이서\n보라색 항공 보급","영웅")
                up("","","","","")
                down("금팔찌","브레이서","","","")
            }
            if(falselist[i].name1 == "미스릴 방패"){
            ...
            if(falselist[i].name1 == "기사의 신조"){
                te("기사의 신조","공격력 +30, 방어력 +25, 체력 재생 +1.5, 이동속도 -0.1, 치명타 피해량 +20%","[제작] 강철 방패 + 분대장 완장\n보라색 항공 보급","영웅")
                up("","","","","")
                down("강철 방패","분대장 완장","","","")
            }
            if(falselist[i].name1 == "샤자한의 검집"){
                te("샤자한의 검집","공격력 +28, 최대 체력 +300, 기본 공격 피해 감소 +2","[제작] 검집 + 루비\n보라색 항공 보급","영웅")
                up("","","","","")
                down("검집","루비","","","")
            }
            if(falselist[i].name1 == "스카디의 팔찌"){
            ...
            if(falselist[i].name1 == "레이더"){
                te("레이더","방어력 +15, 공격속도 +35%, 치명타 확률 +20%","[제작] 바이탈 센서 + 유리판\n노란색 항공 보급","전설")
                up("","","","","")
                down("바이탈 센서","유리판","","","")
            }
            if(falselist[i].name1 == "오토-암즈"){
                te("오토-암즈","공격력 +40, 방어력 +35, 체력 재생 +1.5","[제작] 브레이서 + 포스 코어\n노란색 항공 보급","전설")
                up("","","","","")
                down("브레이서","포스 코어","","","")
            }
            if(falselist[i].name1 == "슬리퍼"){
            ...
            if(falselist[i].name1 == "매버릭 러너"){
                te("매버릭 러너","공격속도 +15%, 이동속도 +0.25, 비전투중 이동속도 +0.5","[제작] 힐리스 + 전자 부품\n파란색 항공 보급","희귀")
                up("","","","","")
                down("힐리스","전자 부품","","","")
            }
            if(falselist[i].name1 == "전투화"){
            ...
            if(falselist[i].name1 == "경량화 부츠"){
                te("경량화 부츠","체력 재생 +1, 공격속도 +30%, 이동속도 +0.4","[제작] 전투화 + 깃털\n보라색 항공 보급","영웅")
                up("","","","","")
                down("전투화","깃털","","","")
            }
            if(falselist[i].name1 == "미스릴 부츠"){
            ...
            if(falselist[i].name1 == "부케 팔로스"){
                te("부케 팔로스","공격력 +5, 방어력 +5, 스태미너 재생 +1, 이동속도 +0.33, 치명타 확률 +17%","[제작]킬힐 + 체인 레깅스\n보라색 항공 보급","영웅")
                up("","","","","")
                down("킬힐","체인 레깅스","","","")
            }
            if(falselist[i].name1 == "클링온 부츠"){
            ...
            if(falselist[i].name1 == "EOD 부츠"){
                te("EOD 부츠","방어력 +23, 체력 재생 +1, 이동속도 +0.33","[제작] 부츠 + 강철 무릎 보호대\n노란색 항공 보급","전설")
                up("","","","","")
                down("부츠","강철 무릎 보호대","","","")
            }
            if(falselist[i].name1 == "글레이셜 슈즈"){
                te("글레이셜 슈즈","체력 재생 +2, 스태미너 재생 +2, 스태미너 재생 +60%, 이동속도 +0.15, 비전투중 이동속도 +0.5, 스킬증폭 +15","[제작] 덧댄 슬리퍼 + 만년빙\n노란색 항공 보급","전설")
                up("","","","","")
                down("만년빙","덧댄 슬리퍼","","","")
            }
            if(falselist[i].name1 == "헤르메스의 부츠"){
...
<<<<<<< HEAD
            ...
            if (falselist[i].name1 == "부채") {
                te("부채", "스킬증폭 +8", "번화가(8개), 숲(8개), 성당(6개)의 상자\n" +
                        "들개(가끔)를 처치", "일반")
                up("군선", "우치와", "우산", "바람 채찍", "")
                down("", "", "", "", "")
            }
            if (falselist[i].name1 == "불경") {
                te("불경", "스킬 증폭 +7%", "절(9개)의 상자\n" +
                        "박쥐(가끔), 들개(가끔)를 처치", "일반")
                up("진신사리", "부적", "법륜", "", "")
                down("", "", "", "", "")
            }
            ...
            if (falselist[i].name1 == "군선") {
                te("군선", "스킬 증폭 +10, 스킬 적중시 치유 감소 -40%", "[제작] 부채 + 못\n초록색 항공 보급", "고급")
                up("백우선", "방천화극", "", "", "")
                down("부채", "못", "", "", "")
            }
            ...
            if (falselist[i].name1 == "우치와") {
                te("우치와", "스태미너 재생 +80%, 생명력 흡수 +17%, 스킬 증폭 +21", "[제작] 인형 + 부채\n파란색 항공 보급", "희귀")
                up("", "", "", "", "")
                down("인형", "부채", "", "", "")
            }
            ...
            if (falselist[i].name1 == "요명월") {
                te("요명월", "방어력 +14, 스태미너 재생 +160%, 고정 스킬 피해 감소 +18, 시야 +1.5", "[제작]\n정화수 + 문스톤", "영웅")
                up("", "", "", "", "")
                down("정화수", "문스톤", "", "", "")
            }
...
=======
            ...
            if(falselist[i].name1 == "저격 스코프"){
                te("저격 스코프","공격력 +6, 시야 +4","[제작] 레이저 포인터 + 쌍안경 \n초록색 항공 보급","고급")
                up("저격 크로스보우","험버커 픽업","","","")
                down("레이저 포인터","쌍안경","","","")
            }
            if(falselist[i].name1 == "진신사리"){
            ...
            if(falselist[i].name1 == "궁기병의 화살통"){
                te("궁기병의 화살통","공격력 +10, 공격속도 +25%, 이동속도 +0.1","[제작] 화살통 + 먼지털이개\n파란색 항공 보급","희귀")
                up("","","","","")
                down("화살통","먼지털이개","","","")
            }
            if(falselist[i].name1 == "달빛 펜던트"){
            ...
            if(falselist[i].name1 == "슈뢰딩거의 상자"){
                te("슈뢰딩거의 상자","최대 체력 +420, 스킬 증폭 +7","[제작] 상자 + 독약\n파란색 항공 보급","희귀")
                up("","","","","")
                down("상자","독약","","","")
            }
            if(falselist[i].name1 == "진리는 나의 빛"){
...
<<<<<<< HEAD
                te("카레 가루", "체력 재생 +250", "고급 주택가(5개), 공장(5개)의 상자", "일반")
=======
...
=======
                te("감자튀김", "체력 재생 +600", "[제작] 감자 + 뜨거운 오일\n파란색 항공 보급", "희귀")
>>>>>>> origin/master
                up("피쉬 앤 칩스", "", "", "", "")
                down("감자", "뜨거운 오일", "", "", "")
            }
...
<<<<<<< HEAD
            if (falselist[i].name1 == "아이스 커피") {
                te("아이스 커피", "스태미너 재생 +500", "[제작] 얼음 + 커피콩\n" +
=======
            if(falselist[i].name1 == "아이스 커피") {
...
=======
            ...
            if(falselist[i].name1 == "올가미"){
                te("올가미","트랩 발동: 대상을 0.5초 간 속박, 트랩 피해 +10","항구(6), 연못(6), 모래사장(5), 양궁장(5), 숲(5), 성당(5)의 상자\n" +
                        "맷돼지(가끔)를 처치","일반")
                up("대나무 트랩","부비트랩","","","")
                down("","","","","")
            }
            if(falselist[i].name1 == "쥐덫"){
                te("쥐덫","트랩 피해 +50","연못(7), 모래사장(5), 묘지(6)의 상자\n" +
                        "맷돼지(가끔)를 처치","")
            ...
            if(falselist[i].name1 == "대나무 트랩"){
                te("대나무 트랩","트랩 발동: 대상을 1초 간 속박합니다.\n" +
                        "트랩 피해 +30","[제작] 올가미 + 대나무\n초록색 항공 보급","고급")
                up("펜듈럼 도끼","","","","")
                down("올가미","대나무","","","")
            }
            ...
            if(falselist[i].name1 == "펜듈럼 도끼"){
                te("펜듈럼 도끼","트랩 발동: 대상을 1초 간 속박합니다\n" +
...
<<<<<<< HEAD
                te("배터리", "", "항구(8개), 번화가(8개), 공장(9개)의 상자\n" +
=======
...
=======
                te("우너석", "", "연못(8개), 모래사장(7개), 절(8개), 숲(8개)의 상자\n" +
>>>>>>> origin/master
                        "들개(가끔)를 처치", "일반")
                up("황금", "루비", "무라마사", "", "")
                down("", "", "", "", "")
...
<<<<<<< HEAD
            ...
            if (falselist[i].name1 == "올가미") {
                te("올가미", "트랩 발동: 트랩 피해 +10", "항구(3), 연못(6), 모래사장(3), 양궁장(3), 숲(5), 성당(3)의 상자\n" +
                        "맷돼지(가끔)를 처치", "일반")
                up("대나무 트랩", "부비트랩", "", "", "")
                down("", "", "", "", "")
            }
