    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): defend.ViewHolder {
        ...
        fun defendarray(i:Int) {
            ...
            if (defend_Item[i].name1 == "수정 티아라") {
                item.te("수정 티아라", "방어력 +24, 최대 스태미너 +500, 치명타 확률 +22%", "[제작]티아라 + 유리 조각\n", "영웅")
                item.up("", "", "", "", "")
                item.down("티아라", "유리 조각", "", "", "")
            }
            ...
            if (defend_Item[i].name1 == "석양의 갑옷") {
                item.te("석양의 갑옷", "방어력 +18어, 최대 체력 +360", "[제작] 가죽 갑옷 + 루비\n파란색 항공 보급", "희귀")
                item.up("", "", "", "", "")
                item.down("가죽 갑옷", "루비", "", "", "")
            }
            if (defend_Item[i].name1 == "어사의") {
                item.te("어사의", "방어력 +26, 시야 +1, 최대 체력 +2, 쿨다운 감소 +15%", "[제작] 한복 + 마패\n", "희귀")
                item.up("활빈검", "", "", "", "")
                item.down("한복", "마패", "", "", "")
            }
            ...
            if (defend_Item[i].name1 == "락커의 자켓") {
                item.te("락커의 자켓", "공격력 +28, 방어력 +18, 비전투중 이동속도 +0.1, 기본 공격 피해 감소 +13, 스킬 적중 시 치유 감소 -40% (원거리 25%)", "[제작] 라이더 자켓 + 소란 발생기\n보라색 항공 보급", "영웅")
                item.up("", "", "", "", "")
            ...
            if (defend_Item[i].name1 == "퀸 오브 하트") {
                item.te("퀸 오브 하트", "방어력 +40, 체력 재생 +2, 착용 시 쿨다운 감소 최대치 40% -> 50%, 쿨다운 감소 +25%", "[제작] VF 혈액 샘플 + 한복\n노란색 항공 보급", "전설")
                item.up("", "", "", "", "")
            ...
            if (defend_Item[i].name1 == "강철 방패") {
                item.te("강철 방패", "공격력 +20, 방어력 +20, 이동속도 -0.05", "[제작] 방패 + 강철\n파란색 항공 보급", "희귀")
                item.up("기사의 신조", "", "", "", "")
                item.down("가죽 방패", "강철", "", "", "")
            }
            if (defend_Item[i].name1 == "큐브 워치") {
                item.te("큐브 워치", "방어력 +22, 공격속도 +50%, 쿨다운 감소 +10%", "[제작] 고장난 시계 + 문스톤\n보란색 항공 보급", "영웅")
                item.up("", "", "", "", "")
            ...
            if (defend_Item[i].name1 == "기사의 신조") {
                item.te("기사의 신조", "공격력 +30, 방어력 +20, 체력 재생 +1.2, 이동속도 -0.03, 치명타 피해량 +25%", "[제작] 강철 방패 + 분대장 완장\n보라색 항공 보급", "영웅")
                item.up("", "", "", "", "")
            ...
            if (defend_Item[i].name1 == "매버릭 러너") {
                item.te("매버릭 러너", "공격력 -8, 이동속도 +0.25, 비전투중 이동속도 +0.3", "[제작] 힐리스 + 전자 부품\n파란색 항공 보급", "희귀")
                item.up("", "", "", "", "")
                item.down("힐리스", "전자 부품", "", "", "")
            }
            ...
            if (defend_Item[i].name1 == "풍화륜") {
                item.te("풍화륜", "스태미너 재생 +0.5, 스태미너 재생 +50%, 이동속도 +0.33, 스킬증폭 +14", "[제작] 덧댄 슬리퍼 + 재\n보라색 항공 보급", "영웅")
                item.up("", "", "", "", "")
                item.down("덧댄 슬리퍼", "재", "", "", "")
            }
            ...
            if (defend_Item[i].name1 == "월왕구천") {
                item.te("월왕구천", "공격력 +15, 스킬증폭 15%", "[제작]\n비파단도 + 정교한 도면", "희귀")
                item.up("", "", "", "", "")
                item.down("비파단도", "정교한 도면", "", "", "")
            }
            if (defend_Item[i].name1 == "요명월") {
                item.te("요명월", "방어력 +15, 스태미너 재생 +180%, 고정 스킬 피해 감소 +18, 시야 +1.5", "[제작]\n정화수 + 문스톤", "영웅")
                item.up("", "", "", "", "")
                item.down("정화수", "문스톤", "", "", "")
            }
