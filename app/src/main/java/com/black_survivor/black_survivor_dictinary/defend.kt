    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): defend.ViewHolder {
        ...
        fun defendarray(i:Int) {
            ...
            if (defend_Item[i].name1 == "모자") {
                item.te("모자", "방어력 +4, 쿨다운 감소 +5%", "연못(7개), 양궁장(5개), 학교(6개)의 상자\n" +
                        "박쥐(가끔)를 처치", "일반")
                item.up("베레모", "사슬 코이프", "", "", "")
                item.down("", "", "", "", "")
            }
            if (defend_Item[i].name1 == "자전거 헬멧") {
                item.te("자전거 헬멧", "최대 체력 +90", "모래사장(6개), 성당(6개), 학교(6개)의 상자\n" +
                        "맷돼지(가끔)를 처치", "일반")
                item.up("안전모", "방탄모", "", "", "")
                item.down("", "", "", "", "")
            }
            ...
            if (defend_Item[i].name1 == "사슬 코이프") {
                item.te("사슬 코이프", "방어력 +14, 쿨다운 감소+10%", "[제작] 모자 + 쇠사슬\n초록색 항공 보급", "고급")
                item.up("투구", "미스릴 투구", "", "", "")
                item.down("모자", "쇠사슬", "", "", "")
            }
            if (defend_Item[i].name1 == "안전모") {
                item.te("안전모", "최대 체력 +210", "[제작] 자전거 헬멧 + 돌멩이\n초록색 항공 보급", "고급")
                item.up("소방 헬멧", "", "", "", "")
            ...
            if (defend_Item[i].name1 == "소방 헬멧") {
                item.te("소방 헬멧", "최대 체력 +280", "[제작] 안전모 + 물\n파란색 항공 보급", "희귀")
                item.up("오토바이 헬멧", "", "", "", "")
                item.down("안전모", "물", "", "", "")
            }
            if (defend_Item[i].name1 == "티아라") {
                item.te("티아라", "방어력 +14, 최대 스태미너 +460", "[제작] 머리테 + 마패\n파란색 항공 보급", "희귀")
                item.up("수정 티아라", "", "", "", "")
                item.down("머리테", "마패", "", "", "")
            }
            if (defend_Item[i].name1 == "왕관") {
                item.te("왕관", "방어력 +16, 최대 스태미너 +360, 스킬 증폭 +11%", "[제작] 머리테 +황금\n파란색 항공 보급", "희귀")
                item.up("제국 왕관", "", "", "", "")
                item.down("머리테", "황금", "", "", "")
            }
            if (defend_Item[i].name1 == "투구") {
                item.te("투구", "방어력 +20, 최대 스태미너 +130, 이동속도 +0.1, 쿨다운 감소 +10%", "[제작]사슬 코이프 + 가면\n파란색 항공 보급", "희귀")
                item.up("기사단장의 투구", "황실 부르고넷", "", "", "")
                item.down("사슬 코이프", "가면", "", "", "")
            }
            if (defend_Item[i].name1 == "오토바이 헬멧") {
                item.te("오토바이 헬멧", "공격력 +10, 최대 체력 +300, 시야 +2.5", "[제작] 소방 헬멧 + 쌍안경\n파란색 항공 보급", "희귀")
                item.up("", "", "", "", "")
                item.down("소방 헬멧", "쌍안경", "", "", "")
            }
            ...
            if (defend_Item[i].name1 == "수정 티아라") {
                item.te("수정 티아라", "방어력 +14, 최대 스태미너 +700, 치명타 확률 +20%", "[제작]티아라 + 유리 조각\n", "영웅")
                item.up("", "", "", "", "")
                item.down("티아라", "유리 조각", "", "", "")
            }
            ...
            if (defend_Item[i].name1 == "제국 왕관") {
                item.te("제국 왕관", "방어력 +18, 최대 체력 +300, 최대 스태미너 +500, 스킬 증폭 +10%", "[제작] 왕관 + 루비\n보라색 항공 보급", "영웅")
                item.up("", "", "", "", "")
                item.down("왕관", "루비", "", "", "")
            }
            if (defend_Item[i].name1 == "황실 부르고넷") {
                item.te("황실 부르고넷", "방어력 +10, 최대 스태미너 +200, 이동속도 +0.1, 쿨다운 감소 +10%, 스킬 증폭 +14%", "[제작] 투구 + 황금\n보라색 항공 보급", "영웅")
                item.up("", "", "", "", "")
                item.down("투구", "황금", "", "", "")
            }
            if (defend_Item[i].name1 == "변검") {
                item.te("변검", "방어력 +16, 최대 스태미너 +300, 이동속도 +0.1, 생명력 흡수 +22%, 비전투중 이동속도 +0.4", "[제작] 가면 + VF 혈액 샘플\n보라색 항공 보급", "영웅")
                item.up("", "", "", "", "")
                item.down("가면", "VF 혈액 샘플", "", "", "")
            }
            if (defend_Item[i].name1 == "월계관") {
                item.te("월계관", "방어력 +18, 최대 스태미너 +580, 체력 재생 +1.5, 스태미너 재생 +2, 기본 공격 추가 피해 +15", "[제작]삼매진화 + 머리테\n노란색 항공 보급", "전설")
                item.up("", "", "", "", "")
                item.down("삼매진화", "머리테", "", "", "")
            }
            ...
            if (defend_Item[i].name1 == "가죽 갑옷") {
                item.te("가죽 갑옷", "방어력 +22", "[제작] 천 갑옷 + 가죽\n초록색 항공 보급", "고급")
            ...
            if (defend_Item[i].name1 == "치파오") {
                item.te("치파오", "공격력 +10, 방어력 +10, 스태미너 재생 +150%", "[제작] 드레스 + 면도칼\n파란색 항공 보급", "희귀")
                item.up("용의 도복", "", "", "", "")
                item.down("드레스", "면도칼", "", "", "")
            }
            if (defend_Item[i].name1 == "판금 갑옷") {
                item.te("판금 갑옷", "방어력 +38, 최대 체력 +100, 이동속도 -0.1", "[제작] 천 갑옷 + 강철\n파란색 항공 보급", "희귀")
                item.up("성기사의 갑옷", "아마조네스 갑옷", "", "", "")
                item.down("천 갑옷", "강철", "", "", "")
            }
            if (defend_Item[i].name1 == "한복") {
                item.te("한복", "방어력 +12, 체력 재생 +1, 쿨다운 감소 +8%", "[제작] 덧댄 로브 + 꽃\n", "희귀")
                item.up("어사의", "퀸 오브 하트", "", "", "")
                item.down("덧댄 로브", "꽃", "", "", "")
            }
            ...
            if (defend_Item[i].name1 == "석양의 갑옷") {
                item.te("석양의 갑옷", "방어력 +28, 최대 체력 +360", "[제작] 가죽 갑옷 + 루비\n파란색 항공 보급", "희귀")
                item.up("", "", "", "", "")
                item.down("", "", "", "", "")
            }
            if (defend_Item[i].name1 == "어사의") {
                item.te("어사의", "방어력 +23, 최대 체력 +2.5, 쿨다운 감소 +15%", "[제작] 한복 + 마패\n", "희귀")
                item.up("활빈검", "", "", "", "")
                item.down("한복", "마패", "", "", "")
            }
            if (defend_Item[i].name1 == "광학미채 슈트") {
                item.te("광학미채 슈트", "공격력 +10, 방어력 +20, 치명타 확률 +22%, 스킬 피해 감소 +10%", "[제작] 잠수복 + 유리판\n보라색 항공 보급", "영웅")
                item.up("", "", "", "", "")
                item.down("잠수복", "유리판", "", "", "")
            }
            if (defend_Item[i].name1 == "락커의 자켓") {
                item.te("락커의 자켓", "공격력 +30, 방어력 +11, 비전투중 이동속도 +0.1, 기본 공격 피해 감소 +15, 스킬 적중 시 치유 감소 -40%", "[제작] 라이더 자켓 + 소란 발생기\n보라색 항공 보급", "영웅")
                item.up("", "", "", "", "")
                item.down("라이더 자켓", "소란 발생기", "", "", "")
            }
            if (defend_Item[i].name1 == "미스릴 갑옷") {
                item.te("미스릴 갑옷", "방어력 +65, 공격속도 +12%, 이동속도 +0.2", "[제작] 미스릴 + 가죽 갑옷\n보라색 항공 보급", "미스릴 갑옷")
                item.up("", "", "", "", "")
                item.down("미스릴", "가죽 갑옷", "", "", "")
            }
            if (defend_Item[i].name1 == "성기사의 갑옷") {
                item.te("성기사의 갑옷", "방어력 +38, 체력 재생 +150%, 이동속도 -0.02, 기본 공격 추가 피해 +15", "[제작] 판금 갑옷 + 성자의 유산\n보라색 항공 보급", "영웅")
                item.up("", "", "", "", "")
                item.down("판금 갑옷", "성자의 유산", "", "", "")
            }
            if (defend_Item[i].name1 == "아마조네스 아머") {
                item.te("아마조네스 아머", "방어력 +28, 최대 체력 +120, 스킬 피해 감소 +20%", "[제작] 판금 갑옷 + 비키니\n보라색 항공 보급", "영웅")
                item.up("", "", "", "", "")
                item.down("판금 갑옷", "비키니", "", "", "")
            }
            if (defend_Item[i].name1 == "용의 도복") {
                item.te("용의 도복", "공격력 +11, 방어력 +10, 스태미너 재생 +150%, 쿨다운 감소 +10%, 기본 공격 사거리 +1", "[제작] 치파오 + 거북 도복\n보라색 항공 보급", "영웅")
                item.up("", "", "", "", "")
                item.down("치파오", "거북 도복", "", "", "")
            }
            if (defend_Item[i].name1 == "지휘관의 갑옷") {
                item.te("지휘관의 갑옷", "방어력 +20, 스킬 증폭 +18%", "[제작] 사슬 갑옷 + 황금\n보라색 항공 보급", "영웅")
                item.up("", "", "", "", "")
                item.down("사슬 갑옷", "황금", "", "", "")
            }
            if (defend_Item[i].name1 == "집사복") {
                item.te("집사복", "공격력 +30, 이동속도 +0.1, 생명력 흡수 +20%, 기본 공격 피해 감소 +10", "[제작] 정장 + 먼지털이개\n보라색 항공 보급", "영웅")
                item.up("", "", "", "", "")
                item.down("정장", "먼지털이개", "", "", "")
            }
            if (defend_Item[i].name1 == "배틀 슈트") {
                item.te("배틀 슈트", "방어력 +25, 최대 체력 +140, 기본 공격 피해 감소 +12, 스킬 피해 감소 +12%", "[제작] 방탄조끼 + 잠수복\n보라색 항공 보급", "영웅")
                item.up("", "", "", "", "")
                item.down("방탄조끼", "잠수복", "", "", "")
            }
            if (defend_Item[i].name1 == "EOD 슈트") {
                item.te("EOD 슈트", "방어력 +20, 최대 체력 +300, 체력 재생 +1, 쿨다운 감소 +10%, 기본 공격 피해 감소 +10", "[제작] 방탄조끼 + 덧댄 로브\n보라색 항공 보급", "영웅")
                item.up("", "", "", "", "")
                item.down("방탄조끼", "덧댄 로브", "", "", "")
            }
            if (defend_Item[i].name1 == "불꽃 드레스") {
                item.te("불꽃 드레스", "방어력 +30, 체력 재생 +2.5, 스태미너 재생 +3, 스태미너 재생 +75%, 기본 공격 추가 피해 +18", "[제작] 삼매진화 + 드레스\n노란색 항공 보급", "전설")
                item.up("", "", "", "", "")
                item.down("", "", "", "", "")
            }
            if (defend_Item[i].name1 == "카바나") {
                item.te("카바나", "방어력 +38, 스킬 증폭 +22%", "[제작] 운석 + 지휘관의 갑옷\n노란색 항공 보급", "전설")
                item.up("", "", "", "", "")
            ...
            if (defend_Item[i].name1 == "손목시계") {
                item.te("손목시계", "공격속도 +10%", "고급 주택가(6개), 호텔(6개), 번화가(8개)의 상자\n" +
                        "들개(가끔)를 처치", "일반")
                item.up("바이탈 센서", "큐브 워치", "", "", "")
                item.down("", "", "", "", "")
            }
            if (defend_Item[i].name1 == "붕대") {
                item.te("붕대", "체력 재생 +0.8", "항구(7개), 병원(6개), 공장(6개), 학교(6)의 상자\n" +
                        "박쥐(가끔)를 처치", "일반")
                item.up("바이탈 센서", "분대장 완장", "브레이서", "구급상자", "기름먹인 천")
                item.down("", "", "", "", "")
            }
            if (defend_Item[i].name1 == "팔찌") {
                item.te("팔찌", "최대 스태미너 +200", "연못(7개), 고급 주택가(6개), 골목길(6개)의 상자\n" +
                        "들개(가끔)를 처치", "일반")
                item.up("금팔찌", "진홍 팔찌", "", "", "")
                item.down("", "", "", "", "")
            }
            if (defend_Item[i].name1 == "가죽 방패") {
                item.te("가죽 방패", "공격력 +10, 방어력 +10", "[제작] 거북이 등딱지 + 가죽\n초록색 항공 보급", "고급")
            ...
            if (defend_Item[i].name1 == "바주반드") {
                item.te("바주반드", "방어력 +25, 기본 공격 피해 감소 +8", "[제작] 브레이서 + 철판\n파란색 항공 보급", "희귀")
                item.up("소드 스토퍼", "", "", "", "")
                item.down("브레이서", "철판", "", "", "")
            }
            ...
            if (defend_Item[i].name1 == "큐브 워치") {
                item.te("큐브 워치", "방어력 +27, 공격속도 +50%", "[제작] 손목시계 + 문스톤\n파란색 항공 보급", "희귀")
                item.up("", "", "", "", "")
                item.down("손목시계", "문스톤", "", "", "")
            }
            if (defend_Item[i].name1 == "소드 스토퍼") {
                item.te("소드 스토퍼", "방어력 +36, 치명타 피해 감소 +10%, 기본 공격 시 치유 감소 -40%", "[제작] 바주반드 + 못\n보라색 항공 보급", "영웅")
                item.up("", "", "", "", "")
                item.down("바주반드", "못", "", "", "")
            }
            ...
            if (defend_Item[i].name1 == "기사의 신조") {
                item.te("기사의 신조", "공격력 +30, 방어력 +20, 체력 재생 +1.5, 이동속도 -0.05, 치명타 피해량 +25%", "[제작] 강철 방패 + 분대장 완장\n보라색 항공 보급", "영웅")
                item.up("", "", "", "", "")
                item.down("강철 방패", "분대장 완장", "", "", "")
            }
            if (defend_Item[i].name1 == "샤자한의 검집") {
                item.te("샤자한의 검집", "공격력 +28, 최대 체력 +260, 기본 공격 피해 감소 +2", "[제작] 검집 + 루비\n보라색 항공 보급", "영웅")
                item.up("", "", "", "", "")
                item.down("검집", "루비", "", "", "")
            }
            if (defend_Item[i].name1 == "아이기스") {
                item.te("아이기스", "체력 +350, 스태미너 +250, 공격력 +10, 방어력 +10", "[제작] 진홍 팔찌 + 가죽 방패\n보라색 항공 보급", "영웅")
                item.up("", "", "", "", "")
                item.down("진홍 팔찌", "가죽 방패", "", "", "")
            }
            if (defend_Item[i].name1 == "스카디의 팔찌") {
                item.te("스카디의 팔찌", "최대 체력 +200, 최대 스태미너 +250, 체력 재생 +2, 스태미너 재생 +2, 스킬 증폭 +20", "[제작] 만년빙 + 진홍 팔찌\n노란색 항공 보급", "전설")
                item.up("", "", "", "", "")
                item.down("만년빙", "진홍 팔찌", "", "", "")
            }
            ...
            if (defend_Item[i].name1 == "슬리퍼") {
                item.te("슬리퍼", "스태미너 재생 +0.5, 이동속도 +0.04", "번화가(8개), 병원(6개), 학교(7개)의 상자\n" +
                        "박쥐(가끔)를 처치", "일반")
                item.up("하이힐", "덧댄 슬리퍼", "", "", "")
                item.down("", "", "", "", "")
            }
            if (defend_Item[i].name1 == "운동화") {
                item.te("운동화", "이동속도 +0.08", "고급 주택가(6개), 골목길(7개), 양궁장(5개)의 상자\n" +
                        "들개(가끔)를 처치", "일반")
                item.up("힐리스", "부츠", "", "", "")
                item.down("", "", "", "", "")
            }
            ...
            if (defend_Item[i].name1 == "무릎 보호대") {
                item.te("무릎 보호대", "방어력 +8, 이동속도 +0.16", "[제작] 타이즈 + 가죽\n초록색 항공 보급", "고급")
                item.up("강철 무릎 보호대", "", "", "", "")
                item.down("타이즈", "가죽", "", "", "")
            }
            ...
            if (defend_Item[i].name1 == "힐리스") {
                item.te("힐리스", "이동속도 +0.12, 비전투중 이동 속도 +0.2", "[제작] 운동화 + 쇠구슬\n초록색 항공 보급", "고급")
            ...
            if (defend_Item[i].name1 == "매버릭 러너") {
                item.te("매버릭 러너", "공격속도 +15%, 이동속도 +0.2, 비전투중 이동속도 +0.55", "[제작] 힐리스 + 전자 부품\n파란색 항공 보급", "희귀")
                item.up("", "", "", "", "")
                item.down("힐리스", "전자 부품", "", "", "")
            }
            ...
            if (defend_Item[i].name1 == "풍화륜") {
                item.te("풍화륜", "스태미너 재생 +1, 스태미너 재생 +50%, 이동속도 +0.35, 스킬증폭 +10", "[제작] 덧댄 슬리퍼 + 재\n파란색 항공 보급", "희귀")
                item.up("", "", "", "", "")
                item.down("덧댄 슬리퍼", "재", "", "", "")
            }
            ...
            if (defend_Item[i].name1 == "미스릴 부츠") {
                item.te("미스릴 부츠", "방어력 +22, 공격속도 +12%, 이동속도 +0.45", "[제작] 미스릴 + 체인 레깅스\n보라색 항공 보급", "영웅")
                item.up("", "", "", "", "")
                item.down("미스릴", "체인 레깅스", "", "", "")
            }
            if (defend_Item[i].name1 == "부케팔로스") {
                item.te("부케 팔로스", "공격력 +5, 방어력 +5, 스태미너 재생 +1, 이동속도 +0.33, 치명타 확률 +15%", "[제작]킬힐 + 체인 레깅스\n보라색 항공 보급", "영웅")
                item.up("", "", "", "", "")
                item.down("킬힐", "체인 레깅스", "", "", "")
            }
            if (defend_Item[i].name1 == "클링온 부츠") {
                item.te("클링온 부츠", "체력 재생 +0.7, 공격속도 +15, 이동속도 +0.35, 기본 공격 시 치유 감소 -40%", "[제작] 전투화 + 못\n보라색 항공 보급", "영웅")
                item.up("", "", "", "", "")
                item.down("전투화", "못", "", "", "")
            }
            if (defend_Item[i].name1 == "EOD 부츠") {
                item.te("EOD 부츠", "방어력 +26, 체력 재생 +1, 이동속도 +0.33", "[제작] 부츠 + 강철 무릎 보호대\n노란색 항공 보급", "전설")
                item.up("", "", "", "", "")
                item.down("부츠", "강철 무릎 보호대", "", "", "")
            }
            if (defend_Item[i].name1 == "글레이셜 슈즈") {
                item.te("글레이셜 슈즈", "체력 재생 +2, 스태미너 재생 +2, 스태미너 재생 +60%, 이동속도 +0.25, 비전투중 이동속도 +0.4, 스킬증폭 +15", "[제작] 덧댄 슬리퍼 + 만년빙\n노란색 항공 보급", "전설")
                item.up("", "", "", "", "")
                item.down("만년빙", "덧댄 슬리퍼", "", "", "")
            }
            if (defend_Item[i].name1 == "헤르메스의 부츠") {
                item.te("헤르메스의 부츠", "방어력 +40, 이동속도 +0.4, 비전투중 이동 속도+0.2", "[제작] 포스 코어 + 힐리스\n노란색 항공 보급", "전설")
                item.up("", "", "", "", "")
                item.down("포스 코어", "힐리스", "", "", "")
            }
            ...
            if (defend_Item[i].name1 == "리본") {
                item.te("리본", "생명력 흡수 +5%", "연못(6개),고급 주택가(7), 학교(7개)의 상자\n" +
                        "들개(가끔)를 처치", "일반")
                item.up("정장", "인형", "달빛 펜던트", "", "")
                item.down("", "", "", "", "")
            }
            if (defend_Item[i].name1 == "부채") {
                item.te("부채", "스킬증폭 +11", "번화가(8개), 숲(8개), 성당(6개)의 상자\n" +
                        "들개(가끔)를 처치", "일반")
                item.up("군선", "우치와", "우산", "바람 채찍", "")
                item.down("", "", "", "", "")
            }
            if (defend_Item[i].name1 == "불경") {
                item.te("불경", "스킬 증폭 +7%", "절(8개)의 상자\n" +
                        "박쥐(가끔), 들개(가끔)를 처치", "일반")
                item.up("진신사리", "부적", "법륜", "", "")
                item.down("", "", "", "", "")
            }
            ...
            if (defend_Item[i].name1 == "쌍안경") {
                item.te("쌍안경", "기본 공격 추가 피해 +7", "모래사장(6개), 골목길(6개), 호텔(6), 공장(7)\n" +
                        "박쥐(가끔), 들개(가끔)를 처치", "일반")
            ...
            if (defend_Item[i].name1 == "운명의 꽃") {
                item.te("운명의 꽃", "치명타 확률 +15%, 쿨다운 감소 +10%", "[제작] 꽃 + 트럼프 카드\n초록색 항공 보급", "고급")
            ...
            if (defend_Item[i].name1 == "화살통") {
                item.te("화살통", "공격속도 +22%", "[제작] 가죽 + 대나무\n초록색 항공 보급", "고급")
                item.up("궁기병의 화살통", "", "", "", "")
                item.down("가죽", "대나무", "", "", "")
            }
            if (defend_Item[i].name1 == "먼지털이개") {
                item.te("먼지털이개", "공격력 +9, 이동속도 +0.1", "[제작] 단봉 + 깃털, 늑대(사냥)\n초록색 항공 보급", "고급")
                item.up("집사복", "궁기병의 화살통", "횃불", "엘레강스", "")
                item.down("단봉", "깃털", "", "", "")
            }
            if (defend_Item[i].name1 == "군선") {
                item.te("군선", "스킬 증폭 +14, 스킬 적중시 치유 감소 -40%", "[제작] 부채 + 못\n초록색 항공 보급", "고급")
                item.up("백우선", "방천화극", "", "", "")
                item.down("부채", "못", "", "", "")
            }
            if (defend_Item[i].name1 == "백우선") {
                item.te("백우선", "이동속도 +0.1, 스킬증폭 +16, 스킬 적중 시 치유 감쇼 -40%", "[제작] 군선 + 깃털\n파란색 항공 보급", "희귀")
                item.up("하르페", "엘리멘탈 보우", "", "", "")
                item.down("군선", "깃털", "", "", "")
            }
            ...
            if (defend_Item[i].name1 == "우치와") {
                item.te("우치와", "스태미너 재생 +100%, 생명력 흡수 +15%, 스킬 증폭 +21", "[제작] 인형 + 부채\n파란색 항공 보급", "희귀")
                item.up("", "", "", "", "")
                item.down("인형", "부채", "", "", "")
            }
            if (defend_Item[i].name1 == "탄창") {
                item.te("탄창", "최대 체력 +350, 기본 공격 피해 감소 +6", "[제작] 상자 + 철판\n파란색 항공 보급", "희귀")
                item.up("XCR", "", "", "", "")
                item.down("상자", "철판", "", "", "")
            }
            ...
            if (defend_Item[i].name1 == "달빛 펜던트") {
                item.te("달빛 펜던트", "공격력 +20, 생명력 흡수 +20%", "[제작] 리본 + 문스톤, 곰(사냥), 위클라인(사냥)\n파란색 항공 보급", "희귀")
                item.up("마법봉", "", "", "", "")
                item.down("리본", "문스톤", "", "", "")
            }
            if (defend_Item[i].name1 == "슈뢰딩거의 상자") {
                item.te("슈뢰딩거의 상자", "최대 체력 +380, 스킬 증폭 +7", "[제작] 상자 + 독약\n파란색 항공 보급", "희귀")
                item.up("", "", "", "", "")
                item.down("상자", "독약", "", "", "")
            }
            if (defend_Item[i].name1 == "진리는 나의 빛") {
                item.te("진리는 나의 빛", "체력 재생 +150%, 쿨다운 감소 +10%, 기본 공격 추가 피해 +12, 스킬 증폭 +8%", "[제작] 진신사리 + 성자의 유산\n파란색 항공 보급", "희귀")
                item.up("", "", "", "", "")
            ...
            if (defend_Item[i].name1 == "삼매진화") {
                item.te("삼매진화", "체력 재생 +1.5, 스태미너 재생 +1.5, 기본 공격 추가 피해 +13", "[제작] 생명의 가루 + 라이터\n보라색 항공 보급", "영웅")
                item.up("레바테인", "월계관", "불꽃 드레스", "화첨창", "")
                item.down("생명의 가루", "라이터", "", "", "")
            }
            if (defend_Item[i].name1 == "에메랄드 타블렛") {
                item.te("에메랄드 타블렛", "공격력 +10, 방어력 +10, 치명타 확률 +15%, 쿨다운 감소 +10%", "[제작] 포스 코어 + 운명의 꽃\n노라색 항공 보급", "전설")
                item.up("", "", "", "", "")
